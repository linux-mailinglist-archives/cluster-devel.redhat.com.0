...
Received: from us-smtp-1.mimecast.com (us-smtp-delivery-1.mimecast.com [205.139.110.120])
	by mail.lfdr.de (Postfix) with ESMTP id E3004177CA6
	for <lists+cluster-devel@lfdr.de>; Tue,  3 Mar 2020 18:02:18 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1583254937;
	...
	bh=CCJfh1BAqalaYw2KArJw70zFp6XcUiaDsm3Z0GTdI5o=;
	b=bYa1e0lK8s7mIpA6KhTASvHPQ+HNjnqeYqUdInOvKvbhL63zt3hipv2fJc1C10RywpbPhn
	Rm+wlbpd5+c2uzkR9xe6Qj1u3meabNTZRFB8Xpi5Fn7FmIiW/Lm+VpdbGn2Bv7/40WJ2n2
	uBP8SDUsfTPpt/hS3SP1Bm+RyMUaaa4=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-174-8OVXTXqGPa6Ac0P-fenJYQ-1; Tue, 03 Mar 2020 12:02:15 -0500
X-MC-Unique: 8OVXTXqGPa6Ac0P-fenJYQ-1
Received: from smtp.corp.redhat.com (int-mx02.intmail.prod.int.phx2.redhat.com [10.5.11.12])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 593C68026AD;
	Tue,  3 Mar 2020 17:02:13 +0000 (UTC)
Received: from colo-mx.corp.redhat.com (colo-mx02.intmail.prod.int.phx2.redhat.com [10.5.11.21])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id 3DE2C60BE1;
	Tue,  3 Mar 2020 17:02:13 +0000 (UTC)
Received: from lists01.pubmisc.prod.ext.phx2.redhat.com (lists01.pubmisc.prod.ext.phx2.redhat.com [10.5.19.33])
	by colo-mx.corp.redhat.com (Postfix) with ESMTP id 24CD586A04;
	Tue,  3 Mar 2020 17:02:12 +0000 (UTC)
Received: from smtp.corp.redhat.com (int-mx04.intmail.prod.int.phx2.redhat.com
	[10.5.11.14])
	by lists01.pubmisc.prod.ext.phx2.redhat.com (8.13.8/8.13.8) with ESMTP
	id 023H2ATK005000 for <cluster-devel@listman.util.phx.redhat.com>;
	Tue, 3 Mar 2020 12:02:10 -0500
Received: by smtp.corp.redhat.com (Postfix)
	id 1A10E5DA76; Tue,  3 Mar 2020 17:02:10 +0000 (UTC)
Delivered-To: cluster-devel@redhat.com
Received: from vishnu.redhat.com (ovpn-116-223.ams2.redhat.com [10.36.116.223])
	by smtp.corp.redhat.com (Postfix) with ESMTP id 9B2AF5E257
	for <cluster-devel@redhat.com>; Tue,  3 Mar 2020 17:02:03 +0000 (UTC)
From: Bob Peterson <rpeterso@redhat.com>
To: cluster-devel <cluster-devel@redhat.com>
Date: Tue,  3 Mar 2020 11:01:54 -0600
Message-Id: <20200303170154.1486598-3-rpeterso@redhat.com>
...
@@ -635,6 +636,8 @@ int gfs2_open_common(struct inode *inode, struct file *=
file)
=20
...
=20
@@ -690,10 +693,8 @@ static int gfs2_release(struct inode *inode, struct fi=
le *file)
...
+=09if (ip->i_qadata && --ip->i_qadata->qa_ref =3D=3D 0) {
 ...
 =09}
@@ -567,7 +571,7 @@ int gfs2_quota_hold(struct gfs2_inode *ip, kuid_t uid, =
kgid_t gid)
 =09=09return 0;
=20
 =09if (ip->i_qadata =3D=3D NULL) {
...
+=09=09error =3D gfs2_qa_get(ip);
 ...
 =09}
@@ -575,18 +579,20 @@ int gfs2_quota_hold(struct gfs2_inode *ip, kuid_t uid=
, kgid_t gid)
...
+=09=09goto out_unhold;
 ...
 =09qd++;
=20
@@ -594,7 +600,7 @@ int gfs2_quota_hold(struct gfs2_inode *ip, kuid_t uid, =
kgid_t gid)
...
+=09=09=09goto out_unhold;
 ...
 =09=09qd++;
 =09}
@@ -603,14 +609,16 @@ int gfs2_quota_hold(struct gfs2_inode *ip, kuid_t uid=
, kgid_t gid)
...
=20
@@ -876,7 +884,7 @@ static int do_sync(unsigned int num_qd, struct gfs2_quo=
ta_data **qda)
...
+=09error =3D gfs2_qa_get(ip);
 ...
 =09=09return error;
=20
@@ -884,8 +892,10 @@ static int do_sync(unsigned int num_qd, struct gfs2_qu=
ota_data **qda)
...
@@ -893,12 +903,12 @@ static int do_sync(unsigned int num_qd, struct gfs2_q=
uota_data **qda)
...
@@ -950,13 +960,15 @@ static int do_sync(unsigned int num_qd, struct gfs2_q=
uota_data **qda)
