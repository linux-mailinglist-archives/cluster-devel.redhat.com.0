...
Received: from us-smtp-delivery-1.mimecast.com (us-smtp-delivery-1.mimecast.com [205.139.110.120])
	by mail.lfdr.de (Postfix) with ESMTP id E2B6714929A
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	...
	bh=M8NL5v87NIYh4udmLlYMBS2foXpc6yWcwAl1ibwa6eo=;
	b=Sgr5yfZCtwVScJFdE88FXZ9z6LVVzeyIiEekJxvSXMTg4kU0S7eDsNoRld4WoxdJcW68v3
	U/dKg6eUpuJQeJiWX8yIhLkzBbLlYVbCU9MZiXwipNxLvhWD3PGNTMZVi3Oe4H7fzYBoic
	TCtwZ5tBRtg1p8m/O6xghIoSBqC0wa4=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-98-4rKYQ6a0Ny2hvCVUiXhUlQ-1; Fri, 24 Jan 2020 20:36:13 -0500
Received: from smtp.corp.redhat.com (int-mx05.intmail.prod.int.phx2.redhat.com [10.5.11.15])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 1E437107ACCC;
	Sat, 25 Jan 2020 01:36:11 +0000 (UTC)
Received: from colo-mx.corp.redhat.com (colo-mx02.intmail.prod.int.phx2.redhat.com [10.5.11.21])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id B463C86819;
	Sat, 25 Jan 2020 01:36:10 +0000 (UTC)
Received: from lists01.pubmisc.prod.ext.phx2.redhat.com (lists01.pubmisc.prod.ext.phx2.redhat.com [10.5.19.33])
	by colo-mx.corp.redhat.com (Postfix) with ESMTP id 7CFDB8595B;
	Sat, 25 Jan 2020 01:36:07 +0000 (UTC)
Received: from smtp.corp.redhat.com (int-mx03.intmail.prod.int.rdu2.redhat.com
	[10.11.54.3])
	by lists01.pubmisc.prod.ext.phx2.redhat.com (8.13.8/8.13.8) with ESMTP
	id 00P1a2Pj011657 for <cluster-devel@listman.util.phx.redhat.com>;
	Fri, 24 Jan 2020 20:36:03 -0500
Received: by smtp.corp.redhat.com (Postfix)
	id BFAEB1049486; Sat, 25 Jan 2020 01:36:02 +0000 (UTC)
Delivered-To: cluster-devel@redhat.com
Received: from mimecast-mx02.redhat.com
	(mimecast01.extmail.prod.ext.rdu2.redhat.com [10.11.55.17])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id BA271104948D
	for <cluster-devel@redhat.com>; Sat, 25 Jan 2020 01:36:00 +0000 (UTC)
Received: from us-smtp-1.mimecast.com (us-smtp-1.mimecast.com [205.139.110.61])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-SHA384 (256/256 bits))
	(No client certificate requested)
	by mimecast-mx02.redhat.com (Postfix) with ESMTPS id B1CBD8E3861
	for <cluster-devel@redhat.com>; Sat, 25 Jan 2020 01:36:00 +0000 (UTC)
Received: from bombadil.infradead.org (bombadil.infradead.org
	[198.137.202.133]) (Using TLS) by relay.mimecast.com with ESMTP id
	us-mta-96-vv8fAb5pPiayGr5vCkkDqg-1; Fri, 24 Jan 2020 20:35:57 -0500
Received: from willy by bombadil.infradead.org with local (Exim 4.92.3 #3 (Red
	Hat Linux)) id 1ivAMd-0006VV-B6; Sat, 25 Jan 2020 01:35:55 +0000
...
MIME-Version: 1.0
X-MC-Unique: vv8fAb5pPiayGr5vCkkDqg-1
X-MC-Unique: 4rKYQ6a0Ny2hvCVUiXhUlQ-1
X-Scanned-By: MIMEDefang 2.78 on 10.11.54.3
X-MIME-Autoconverted: from quoted-printable to 8bit by
	lists01.pubmisc.prod.ext.phx2.redhat.com id 00P1a2Pj011657
X-loop: cluster-devel@redhat.com
Cc: cluster-devel@redhat.com, linux-mm@kvack.org, ocfs2-devel@oss.oracle.com,
	linux-kernel@vger.kernel.org,
	"Matthew Wilcox \(Oracle\)" <willy@infradead.org>
Subject: [Cluster-devel] [PATCH 05/12] fs: Convert mpage_readpages to
	mpage_readahead
...
@@ -3005,10 +3005,11 @@ static int exfat_readpage(struct file *file, struct=
 page *page)
...
c)
@@ -3107,7 +3108,7 @@ static sector_t _exfat_bmap(struct address_space *map=
ping, sector_t block)
=20
...
--- a/fs/fat/inode.c
+++ b/fs/fat/inode.c
@@ -209,10 +209,10 @@ static int fat_readpage(struct file *file, struct pag=
e *page)
...
@@ -343,7 +343,7 @@ int fat_block_truncate_page(struct inode *inode, loff_t=
 from)
=20
...
--- a/fs/gfs2/aops.c
+++ b/fs/gfs2/aops.c
@@ -579,7 +579,7 @@ int gfs2_internal_read(struct gfs2_inode *ip, char *buf=
, loff_t *pos,
 }
=20
 /**
...
@@ -592,16 +592,15 @@ int gfs2_internal_read(struct gfs2_inode *ip, char *b=
uf, loff_t *pos,
...
-=09struct gfs2_sbd *sdp =3D GFS2_SB(inode);
 ...
 =09int ret;
=20
@@ -610,13 +609,12 @@ static int gfs2_readpages(struct file *file, struct a=
...
@@ -844,7 +842,7 @@ static const struct address_space_operations gfs2_jdata=
_aops =3D {
...
--- a/mm/migrate.c
+++ b/mm/migrate.c
@@ -1019,7 +1019,7 @@ static int __unmap_and_move(struct page *page, struct=
 page *newpage,
