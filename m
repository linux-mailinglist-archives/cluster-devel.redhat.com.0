...
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [63.128.21.124])
	by mail.lfdr.de (Postfix) with ESMTP id 2956C2CA69C
	for <lists+cluster-devel@lfdr.de>; Tue,  1 Dec 2020 16:10:37 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1606835436;
	...
	bh=Hj26sEtOTokb51e3pr/Es57Y5sudLWZ5nCgR/baIwvM=;
	b=Y5ioA6YW6qBtNFTMIF2GSSZOy8PYfHYux1v29afIkujuQGN5np1Vj33g3PP/ZeJGrxuzeb
	/ZZ4a4yPvIAnbbMZHWwCmVuiggZt9cPDp+/L2jajhcj0rdimilb+QGdQe5mZEDg0sMMYPc
	H0Bp2xkxDW+SX5yN06JXzBA9UIheQBE=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-106-RduAUEN5NGecYd4wqZ52Qw-1; Tue, 01 Dec 2020 10:10:34 -0500
X-MC-Unique: RduAUEN5NGecYd4wqZ52Qw-1
Received: from smtp.corp.redhat.com (int-mx05.intmail.prod.int.phx2.redhat.com [10.5.11.15])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 5CD20185E48E;
	Tue,  1 Dec 2020 15:10:31 +0000 (UTC)
Received: from colo-mx.corp.redhat.com (colo-mx01.intmail.prod.int.phx2.redhat.com [10.5.11.20])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id 4002E5D6AB;
	Tue,  1 Dec 2020 15:10:31 +0000 (UTC)
Received: from lists01.pubmisc.prod.ext.phx2.redhat.com (lists01.pubmisc.prod.ext.phx2.redhat.com [10.5.19.33])
	by colo-mx.corp.redhat.com (Postfix) with ESMTP id 262AB1809CA4;
	Tue,  1 Dec 2020 15:10:31 +0000 (UTC)
Received: from smtp.corp.redhat.com (int-mx05.intmail.prod.int.phx2.redhat.com
	[10.5.11.15])
	by lists01.pubmisc.prod.ext.phx2.redhat.com (8.13.8/8.13.8) with ESMTP
	id 0B1FATGO019731 for <cluster-devel@listman.util.phx.redhat.com>;
	Tue, 1 Dec 2020 10:10:29 -0500
Received: by smtp.corp.redhat.com (Postfix)
	id 921E55D71D; Tue,  1 Dec 2020 15:10:29 +0000 (UTC)
Delivered-To: cluster-devel@redhat.com
Received: from carbon.redhat.com (ovpn-114-202.rdu2.redhat.com [10.10.114.202])
	by smtp.corp.redhat.com (Postfix) with ESMTP id F16465D6AB;
	Tue,  1 Dec 2020 15:10:28 +0000 (UTC)
From: Alexander Aring <aahringo@redhat.com>
To: teigland@redhat.com
Date: Tue,  1 Dec 2020 10:09:56 -0500
Message-Id: <20201201150957.115068-17-aahringo@redhat.com>
...
Subject: [Cluster-devel] [PATCHv2 dlm/next 16/17] fs: dlm: add reliable
...
---
 ...
 fs/dlm/lowcomms.h     |    7 +-
 fs/dlm/midcomms.c     | 1071 +++++++++++++++++++++++++++++++++++++++--
 3 files changed, 1052 insertions(+), 53 deletions(-)
...
index 8286531f9a9e..df5dec098235 100644
--- a/fs/dlm/lowcomms.h
+++ b/fs/dlm/lowcomms.h
@@ -12,7 +12,12 @@
...
index 8e702d20ce9f..f8f4c682e505 100644
--- a/fs/dlm/midcomms.c
+++ b/fs/dlm/midcomms.c
@@ -13,67 +13,717 @@
  * midcomms.c
...
+	dlm_receive_buffer(p, nodeid);
 ...
 /*
@@ -91,7 +741,7 @@ int dlm_process_incoming_buffer(int nodeid, unsigned char *buf, int len)
 	int ret = 0;
...
@@ -111,32 +761,19 @@ int dlm_process_incoming_buffer(int nodeid, unsigned char *buf, int len)
 		if (msglen > len)
 			break;
...
-skip:
 		...
 		len -= msglen;
 		ptr += msglen;
@@ -144,3 +781,337 @@ int dlm_process_incoming_buffer(int nodeid, unsigned char *buf, int len)
