...
Received: from us-smtp-1.mimecast.com (us-smtp-1.mimecast.com [207.211.31.81])
	by mail.lfdr.de (Postfix) with ESMTP id AEBFB163A5D
	for <lists+cluster-devel@lfdr.de>; Wed, 19 Feb 2020 03:41:26 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1582080085;
	...
	bh=0D046L5d2i9UwKfUvw10d95/oEC0ENOUD/7Uw+pVcbY=;
	b=XvO2hhkrWZdAdrjtTcYgiyNuvr3dfq+x5LwwL2J/ZrGc5V+hdX6eUCs83hwTK6ra9M8dYE
	bSZb3Ucm8BsdUDckoOGYgxjXWesard8FTRVBb9sgRHUwZzz9ANMrShN2RouRJZMfIbdeSZ
	v/zoXielIw7xF00QucrU3iywwmHnAPI=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-363-nIDp7WUGNnSn09KnrIYpFA-1; Tue, 18 Feb 2020 21:41:24 -0500
Received: from smtp.corp.redhat.com (int-mx06.intmail.prod.int.phx2.redhat.com [10.5.11.16])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 8108518AB2C0;
	Wed, 19 Feb 2020 02:41:21 +0000 (UTC)
Received: from colo-mx.corp.redhat.com (colo-mx02.intmail.prod.int.phx2.redhat.com [10.5.11.21])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id E66B05C1B0;
	Wed, 19 Feb 2020 02:41:20 +0000 (UTC)
Received: from lists01.pubmisc.prod.ext.phx2.redhat.com (lists01.pubmisc.prod.ext.phx2.redhat.com [10.5.19.33])
	by colo-mx.corp.redhat.com (Postfix) with ESMTP id 6577435AF5;
	Wed, 19 Feb 2020 02:41:20 +0000 (UTC)
Received: from smtp.corp.redhat.com (int-mx05.intmail.prod.int.rdu2.redhat.com
	[10.11.54.5])
	by lists01.pubmisc.prod.ext.phx2.redhat.com (8.13.8/8.13.8) with ESMTP
	id 01J2fGpW004030 for <cluster-devel@listman.util.phx.redhat.com>;
	Tue, 18 Feb 2020 21:41:16 -0500
Received: by smtp.corp.redhat.com (Postfix)
	id 7778CEB332; Wed, 19 Feb 2020 02:41:16 +0000 (UTC)
Delivered-To: cluster-devel@redhat.com
Received: from mimecast-mx02.redhat.com
	(mimecast01.extmail.prod.ext.rdu2.redhat.com [10.11.55.17])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id 6F7D9EC4AC
	for <cluster-devel@redhat.com>; Wed, 19 Feb 2020 02:41:14 +0000 (UTC)
Received: from us-smtp-1.mimecast.com (us-smtp-delivery-1.mimecast.com
	[205.139.110.120])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-SHA384 (256/256 bits))
	(No client certificate requested)
	by mimecast-mx02.redhat.com (Postfix) with ESMTPS id 902DF867B02
	for <cluster-devel@redhat.com>; Wed, 19 Feb 2020 02:41:14 +0000 (UTC)
Received: from huawei.com (szxga01-in.huawei.com [45.249.212.187]) (Using
	TLS) by relay.mimecast.com with ESMTP id
	us-mta-158-qbmCk-nYNCOqOhgMwivQlQ-1; Tue, 18 Feb 2020 21:41:11 -0500
Received: from DGGEMM406-HUB.china.huawei.com (unknown [172.30.72.56])
	by Forcepoint Email with ESMTP id 245B626217D9D6DA7E4E;
	Wed, 19 Feb 2020 10:41:08 +0800 (CST)
Received: from dggeme762-chm.china.huawei.com (10.3.19.108) by
	DGGEMM406-HUB.china.huawei.com (10.3.20.214) with Microsoft SMTP Server
	(TLS) id 14.3.439.0; Wed, 19 Feb 2020 10:41:07 +0800
...
X-MC-Unique: qbmCk-nYNCOqOhgMwivQlQ-1
X-MC-Unique: nIDp7WUGNnSn09KnrIYpFA-1
X-Scanned-By: MIMEDefang 2.79 on 10.11.54.5
X-MIME-Autoconverted: from quoted-printable to 8bit by
	lists01.pubmisc.prod.ext.phx2.redhat.com id 01J2fGpW004030
...
> --- a/fs/erofs/data.c
> +++ b/fs/erofs/data.c
> @@ -280,47 +280,36 @@ static int erofs_raw_access_readpage(struct file *f=
ile, struct page *page)
>  =09return 0;
>  }
> =20
...
> @@ -358,7 +347,7 @@ static sector_t erofs_bmap(struct address_space *mapp=
ing, sector_t block)
...
> --- a/fs/erofs/zdata.c
> +++ b/fs/erofs/zdata.c
> @@ -1315,7 +1315,7 @@ static int z_erofs_readpages(struct file *filp, str=
