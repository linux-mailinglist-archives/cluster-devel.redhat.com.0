...
Received: from us-smtp-1.mimecast.com (us-smtp-delivery-1.mimecast.com [207.211.31.120])
	by mail.lfdr.de (Postfix) with ESMTP id 7AC3417C39C
	for <lists+cluster-devel@lfdr.de>; Fri,  6 Mar 2020 18:05:56 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1583514355;
	...
	bh=KXxcWm3XH/CnrhIk+GUhsa4mxUWeCYjvd1ZXc3ceq9Q=;
	b=CIF3/i54hz0uOJVOREHYutb6EsjcUrmr/bMOtxlM7wPbUvZssH4iXyXWkyRYgtoGxI1Xmr
	QiZx3cjDOM8rE/kmoT5d3FyV5e9S5e3uZziDxmQwM03I9OAojFYugXIBy98xx8TrwSmXqy
	am8KdyX3ysrUXmOTvD22XxUQwCkTNF8=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-23-bp0YPxJIPruTUJiSd5SDpQ-1; Fri, 06 Mar 2020 12:05:53 -0500
X-MC-Unique: bp0YPxJIPruTUJiSd5SDpQ-1
Received: from smtp.corp.redhat.com (int-mx04.intmail.prod.int.phx2.redhat.com [10.5.11.14])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 7571713F8;
	Fri,  6 Mar 2020 17:05:49 +0000 (UTC)
Received: from colo-mx.corp.redhat.com (colo-mx02.intmail.prod.int.phx2.redhat.com [10.5.11.21])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id 626975DE52;
	Fri,  6 Mar 2020 17:05:49 +0000 (UTC)
Received: from lists01.pubmisc.prod.ext.phx2.redhat.com (lists01.pubmisc.prod.ext.phx2.redhat.com [10.5.19.33])
	by colo-mx.corp.redhat.com (Postfix) with ESMTP id 4A8F286A04;
	Fri,  6 Mar 2020 17:05:49 +0000 (UTC)
Received: from smtp.corp.redhat.com (int-mx01.intmail.prod.int.phx2.redhat.com
	[10.5.11.11])
	by lists01.pubmisc.prod.ext.phx2.redhat.com (8.13.8/8.13.8) with ESMTP
	id 026H5lfY028732 for <cluster-devel@listman.util.phx.redhat.com>;
	Fri, 6 Mar 2020 12:05:47 -0500
Received: by smtp.corp.redhat.com (Postfix)
	id AEE888F343; Fri,  6 Mar 2020 17:05:47 +0000 (UTC)
Delivered-To: cluster-devel@redhat.com
Received: from vishnu.redhat.com (ovpn-116-223.ams2.redhat.com [10.36.116.223])
	by smtp.corp.redhat.com (Postfix) with ESMTP id 321B68B74D
	for <cluster-devel@redhat.com>; Fri,  6 Mar 2020 17:05:45 +0000 (UTC)
From: Bob Peterson <rpeterso@redhat.com>
To: cluster-devel <cluster-devel@redhat.com>
Date: Fri,  6 Mar 2020 11:05:31 -0600
Message-Id: <20200306170534.1772544-4-rpeterso@redhat.com>
...
Subject: [Cluster-devel] [GFS2 PATCH 3/6] gfs2: Change inode qa_data to
...
index 54b0708e6d35..3fd45df224aa 100644
--- a/fs/gfs2/file.c
+++ b/fs/gfs2/file.c
...
=20
@@ -1157,6 +1160,7 @@ static long gfs2_fallocate(struct file *file, int mod=
e, loff_t offset, loff_t le
=20
 =09=09if (ret)
