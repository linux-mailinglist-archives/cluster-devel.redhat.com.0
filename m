...
Received: from us-smtp-delivery-1.mimecast.com (us-smtp-2.mimecast.com [205.139.110.61])
	by mail.lfdr.de (Postfix) with ESMTP id 0E540158747
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	...
	bh=HeFQV4ueYkvmNMpvgMrZcZ9635kKQGpz0YGv9ArWgWM=;
	b=KfBhnlnM/qWjZcEKL4XW2d2+DfO76XJTfcZH+BKWBYzSIQrj8idTq87Hb9uGr80ckqvDOJ
	rnf/f30cFlb2Z3qsK90EAqJX8PQb3LeG0XOZXBoGYUDD5ieRk8Y2yEhRw0VL+XXxdXs2hZ
	quH+DryHDwaPsuDXptgMFKjW9eqXJlU=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-270-uUEeUsz0OemDTEGBDRqXrw-1; Mon, 10 Feb 2020 20:04:13 -0500
Received: from smtp.corp.redhat.com (int-mx03.intmail.prod.int.phx2.redhat.com [10.5.11.13])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by mimecast-mx01.redhat.com (Postfix) with ESMTPS id D361B18FE862;
	Tue, 11 Feb 2020 01:04:10 +0000 (UTC)
Received: from colo-mx.corp.redhat.com (colo-mx01.intmail.prod.int.phx2.redhat.com [10.5.11.20])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id C016E87B32;
	Tue, 11 Feb 2020 01:04:10 +0000 (UTC)
Received: from lists01.pubmisc.prod.ext.phx2.redhat.com (lists01.pubmisc.prod.ext.phx2.redhat.com [10.5.19.33])
	by colo-mx.corp.redhat.com (Postfix) with ESMTP id 0147318089C8;
	Tue, 11 Feb 2020 01:04:08 +0000 (UTC)
Received: from smtp.corp.redhat.com (int-mx04.intmail.prod.int.rdu2.redhat.com
	[10.11.54.4])
	by lists01.pubmisc.prod.ext.phx2.redhat.com (8.13.8/8.13.8) with ESMTP
	id 01B144PW019375 for <cluster-devel@listman.util.phx.redhat.com>;
	Mon, 10 Feb 2020 20:04:04 -0500
Received: by smtp.corp.redhat.com (Postfix)
	id 9F941206320B; Tue, 11 Feb 2020 01:04:04 +0000 (UTC)
Delivered-To: cluster-devel@redhat.com
Received: from mimecast-mx02.redhat.com
	(mimecast06.extmail.prod.ext.rdu2.redhat.com [10.11.55.22])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id 98D10206320D
	for <cluster-devel@redhat.com>; Tue, 11 Feb 2020 01:04:02 +0000 (UTC)
Received: from us-smtp-1.mimecast.com (us-smtp-delivery-1.mimecast.com
	[205.139.110.120])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-SHA384 (256/256 bits))
	(No client certificate requested)
	by mimecast-mx02.redhat.com (Postfix) with ESMTPS id 56D5F185B0A9
	for <cluster-devel@redhat.com>; Tue, 11 Feb 2020 01:04:02 +0000 (UTC)
Received: from bombadil.infradead.org (bombadil.infradead.org
	[198.137.202.133]) (Using TLS) by relay.mimecast.com with ESMTP id
	us-mta-254--ot2nj7CPI6cget6Hre_hg-1; Mon, 10 Feb 2020 20:03:59 -0500
...
MIME-Version: 1.0
X-MC-Unique: -ot2nj7CPI6cget6Hre_hg-1
X-MC-Unique: uUEeUsz0OemDTEGBDRqXrw-1
X-Scanned-By: MIMEDefang 2.78 on 10.11.54.4
X-MIME-Autoconverted: from quoted-printable to 8bit by
	lists01.pubmisc.prod.ext.phx2.redhat.com id 01B144PW019375
...
Subject: [Cluster-devel] [PATCH v5 07/13] btrfs: Convert from readpages to
	readahead
...
@@ -664,6 +664,32 @@ static inline struct page *readahead_page(struct reada=
head_control *rac)
...
+=09XA_STATE(xas, &rac->mapping->i_pages, rac->start);
+=09struct page *page;
+
+=09rac->batch_count =3D 0;
+=09xas_for_each(&xas, page, rac->start + rac->nr_pages - 1) {
+=09=09array[batch++] =3D page;
+=09=09rac->batch_count +=3D hpage_nr_pages(page);
+=09=09rac->start +=3D hpage_nr_pages(page);
+=09=09if (PageHead(page))
+=09=09=09xas_set(&xas, rac->start);
+
...
+=09=09=09rac->nr_pages -=3D rac->batch_count)
+
