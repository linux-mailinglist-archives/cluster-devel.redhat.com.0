...
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	by mail.lfdr.de (Postfix) with ESMTPS id 4285C632CD4
	for <lists+cluster-devel@lfdr.de>; Mon, 21 Nov 2022 20:17:12 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1669058230;
	...
	bh=UT23sXjt91QoCm2y+7nYRldsP+o4UrIUg9u3EI5T/sA=;
	b=LmoYocfw9LW9vEzErbG6uR7aYf1fMbTOMyxsaWSzLrS7CeL1eWXVnuAtHOtWiRS5cawZRs
	/mThENro+rVIf8ZsMtxCLiRLAlGWyiQiuviSDc5wUiS8gVxP9c6hzbhtDAwFvo9QpNKt2h
	MKEHVB/mHL7ETXSeOU7aPT+JprD9ZG8=
Received: from mimecast-mx02.redhat.com (mx3-rdu2.redhat.com
 [66.187.233.73]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-83-4SglgQofMBSfArTWSuKpFQ-1; Mon, 21 Nov 2022 14:17:07 -0500
X-MC-Unique: 4SglgQofMBSfArTWSuKpFQ-1
Received: from smtp.corp.redhat.com (int-mx08.intmail.prod.int.rdu2.redhat.com [10.11.54.8])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by mimecast-mx02.redhat.com (Postfix) with ESMTPS id B31561C05AC8;
	Mon, 21 Nov 2022 19:17:06 +0000 (UTC)
Received: from mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (unknown [10.30.29.100])
	by smtp.corp.redhat.com (Postfix) with ESMTP id BDCAFC15BB9;
	Mon, 21 Nov 2022 19:17:05 +0000 (UTC)
Received: from mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (localhost [IPv6:::1])
	by mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (Postfix) with ESMTP id 7F51C194658F;
	Mon, 21 Nov 2022 19:17:05 +0000 (UTC)
...
Received: from smtp.corp.redhat.com (int-mx08.intmail.prod.int.rdu2.redhat.com
 ...
 ESMTP id 77B941946588 for <cluster-devel@listman.corp.redhat.com>;
 Mon, 21 Nov 2022 19:17:03 +0000 (UTC)
Received: by smtp.corp.redhat.com (Postfix)
 id 31417C15BB9; Mon, 21 Nov 2022 19:17:03 +0000 (UTC)
Delivered-To: cluster-devel@redhat.com
Received: from mimecast-mx02.redhat.com
 (mimecast04.extmail.prod.ext.rdu2.redhat.com [10.11.55.20])
 by smtp.corp.redhat.com (Postfix) with ESMTPS id 28783C15BB3
 for <cluster-devel@redhat.com>; Mon, 21 Nov 2022 19:17:03 +0000 (UTC)
Received: from us-smtp-1.mimecast.com (us-smtp-1.mimecast.com [207.211.31.81])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256
 bits)) (No client certificate requested)
 by mimecast-mx02.redhat.com (Postfix) with ESMTPS id F37BD101A528
 for <cluster-devel@redhat.com>; Mon, 21 Nov 2022 19:17:02 +0000 (UTC)
Received: from ams.source.kernel.org (ams.source.kernel.org [145.40.68.75])
 by relay.mimecast.com with ESMTP with STARTTLS (version=TLSv1.2,
 cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-495-slS7m5RMPCuOcOoNrk0CGg-1; Mon, 21 Nov 2022 14:16:59 -0500
X-MC-Unique: slS7m5RMPCuOcOoNrk0CGg-1
...
> > > > + */
> > > > +struct file_lock {
> > > > +=09struct file_lock *fl_blocker;=09/* The lock, that is blocking u=
s */
> > > > +=09struct list_head fl_list;=09/* link into file_lock_context */
> > > > +=09struct hlist_node fl_link;=09/* node in global lists */
> > > > +=09struct list_head fl_blocked_requests;=09/* list of requests wit=
h
...
> > > > +=09loff_t fl_end;
> > > > +
> > > > +=09struct fasync_struct *=09fl_fasync; /* for lease break notifica=
tions */
> > > > +=09/* for lease breaks: */
> > > > +=09unsigned long fl_break_time;
> > > > +=09unsigned long fl_downgrade_time;
> > > > +
> > > > +=09const struct file_lock_operations *fl_ops;=09/* Callbacks for f=
ilesystems */
> > > > +=09const struct lock_manager_operations *fl_lmops;=09/* Callbacks =
for lockmanagers */
> > > > +=09union {
> > > > +=09=09struct nfs_lock_info=09nfs_fl;
> > > > +=09=09struct nfs4_lock_info=09nfs4_fl;
> > > > +=09=09struct {
> > > > +=09=09=09struct list_head link;=09/* link in AFS vnode's pending_l=
ocks list */
...
> > > > +{
> > > > +=09/*
> > > > +=09 * Since this check is lockless, we must ensure that any refcou=
nts
> > > > +=09 * taken are done before checking i_flctx->flc_lease. Otherwise=
, we
> > > > +=09 * could end up racing with tasks trying to set a new lease on =
this
> > > > +=09 * file.
> > > > +=09 */
> > > > +=09smp_mb();
> > > > +=09if (inode->i_flctx && !list_empty_careful(&inode->i_flctx->flc_=
lease))
...
king space */
> > > >  #ifndef OFFSET_MAX
> > > >  #define INT_LIMIT(x)=09(~((x)1 << (sizeof(x)*8 - 1)))
