...
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	by mail.lfdr.de (Postfix) with ESMTPS id 3B465632899
	for <lists+cluster-devel@lfdr.de>; Mon, 21 Nov 2022 16:48:23 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1669045701;
	...
	bh=EbkJrA9uUqQeAoMaP/QHHpfZ6mOf336pwMtEU0sxJeU=;
	b=S/P6ssqFJpw7yekIMBxmIuRoU25bwIMZaaxdMC6ApCayh7JW9vw0sbk6JXt0OTOjFmF2Rb
	tt3Jx4sroi+xjv576K06wmAhFw3AguyTMxChaVUblHgE1ek0Z2CMBHke+IbTtud//OhaSh
	58lEkq2Zgy8QXEtYwCSI/FpcH9mhafc=
Received: from mimecast-mx02.redhat.com (mimecast-mx02.redhat.com
 [66.187.233.88]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-481-3AZVVDFPOXufUQXJZb0AxQ-1; Mon, 21 Nov 2022 10:48:13 -0500
X-MC-Unique: 3AZVVDFPOXufUQXJZb0AxQ-1
Received: from smtp.corp.redhat.com (int-mx09.intmail.prod.int.rdu2.redhat.com [10.11.54.9])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by mimecast-mx02.redhat.com (Postfix) with ESMTPS id F2D4519705A9;
	Mon, 21 Nov 2022 15:48:11 +0000 (UTC)
Received: from mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (unknown [10.30.29.100])
	by smtp.corp.redhat.com (Postfix) with ESMTP id B45A249BB64;
	Mon, 21 Nov 2022 15:48:11 +0000 (UTC)
Received: from mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (localhost [IPv6:::1])
	by mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (Postfix) with ESMTP id 9FD24194658C;
	Mon, 21 Nov 2022 15:48:07 +0000 (UTC)
X-Original-To: cluster-devel@listman.corp.redhat.com
Delivered-To: cluster-devel@listman.corp.redhat.com
Received: from smtp.corp.redhat.com (int-mx05.intmail.prod.int.rdu2.redhat.com
 [10.11.54.5])
 by mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (Postfix) with
 ESMTP id BF4281946587 for <cluster-devel@listman.corp.redhat.com>;
 Mon, 21 Nov 2022 15:42:30 +0000 (UTC)
Received: by smtp.corp.redhat.com (Postfix)
 id AE94617593; Mon, 21 Nov 2022 15:42:30 +0000 (UTC)
Delivered-To: cluster-devel@redhat.com
Received: from mimecast-mx02.redhat.com
 (mimecast01.extmail.prod.ext.rdu2.redhat.com [10.11.55.17])
 by smtp.corp.redhat.com (Postfix) with ESMTPS id A466F17582
 for <cluster-devel@redhat.com>; Mon, 21 Nov 2022 15:42:30 +0000 (UTC)
Received: from us-smtp-1.mimecast.com (us-smtp-2.mimecast.com [205.139.110.61])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by mimecast-mx02.redhat.com (Postfix) with ESMTPS id 792D285A588
 for <cluster-devel@redhat.com>; Mon, 21 Nov 2022 15:42:30 +0000 (UTC)
Received: from mx0b-00069f02.pphosted.com (mx0b-00069f02.pphosted.com
 [205.220.177.32]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-58-U-YAKBKKMrGuhv4DJn39uA-1; Mon, 21 Nov 2022 10:42:25 -0500
X-MC-Unique: U-YAKBKKMrGuhv4DJn39uA-1
...
X-Mailman-Approved-At: Mon, 21 Nov 2022 15:48:07 +0000
...
> +
> +=09const struct file_lock_operations *fl_ops;=09/* Callbacks for filesys=
tems */
> +=09const struct lock_manager_operations *fl_lmops;=09/* Callbacks for lo=
ckmanagers */
> +=09union {
> +=09=09struct nfs_lock_info=09nfs_fl;
> +=09=09struct nfs4_lock_info=09nfs4_fl;
> +=09=09struct {
> +=09=09=09struct list_head link;=09/* link in AFS vnode's pending_locks l=
ist */
