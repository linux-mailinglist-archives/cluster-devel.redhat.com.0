...
Received: from us-smtp-1.mimecast.com (us-smtp-2.mimecast.com [207.211.31.81])
	by mail.lfdr.de (Postfix) with ESMTP id 498F91A3F15
	for <lists+cluster-devel@lfdr.de>; Fri, 10 Apr 2020 05:47:56 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1586490475;
	...
	bh=liyPBkrTLYsMX2DkTuBFV/LSU25SS7QmvtwoPCxJKjc=;
	b=BJ+bTEBOFspBfIYrgF1n8SiZtOlcr3kfHrKaYM01CnJePfh/gCyqJnhAh99I5BQV3TRqH7
	XxeLqIMGod8VlxmJZsRhDsZ+mCuwIXU1Nw9B2hCc7O9MDUqGchNuVlQ3F6wwpKKWCPlcry
	dUjKe61j9eWjetgbyZEEtAVQ7DXgLFY=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-513-2kWxudzoO1OpLrM9L3Mwnw-1; Thu, 09 Apr 2020 23:47:53 -0400
X-MC-Unique: 2kWxudzoO1OpLrM9L3Mwnw-1
Received: from smtp.corp.redhat.com (int-mx03.intmail.prod.int.phx2.redhat.com [10.5.11.13])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by mimecast-mx01.redhat.com (Postfix) with ESMTPS id D0ACE13FF;
	Fri, 10 Apr 2020 03:47:50 +0000 (UTC)
Received: from colo-mx.corp.redhat.com (colo-mx02.intmail.prod.int.phx2.redhat.com [10.5.11.21])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id 187AC9DD96;
	Fri, 10 Apr 2020 03:47:50 +0000 (UTC)
Received: from lists01.pubmisc.prod.ext.phx2.redhat.com (lists01.pubmisc.prod.ext.phx2.redhat.com [10.5.19.33])
	by colo-mx.corp.redhat.com (Postfix) with ESMTP id E683393085;
	Fri, 10 Apr 2020 03:47:49 +0000 (UTC)
Received: from smtp.corp.redhat.com (int-mx03.intmail.prod.int.rdu2.redhat.com
	[10.11.54.3])
	by lists01.pubmisc.prod.ext.phx2.redhat.com (8.13.8/8.13.8) with ESMTP
	id 03A3lcx2016734 for <cluster-devel@listman.util.phx.redhat.com>;
	Thu, 9 Apr 2020 23:47:38 -0400
Received: by smtp.corp.redhat.com (Postfix)
	id 00B0D1006B28; Fri, 10 Apr 2020 03:47:38 +0000 (UTC)
Delivered-To: cluster-devel@redhat.com
Received: from mimecast-mx02.redhat.com
	(mimecast02.extmail.prod.ext.rdu2.redhat.com [10.11.55.18])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id F07E21006B32
	for <cluster-devel@redhat.com>; Fri, 10 Apr 2020 03:47:36 +0000 (UTC)
Received: from us-smtp-1.mimecast.com (us-smtp-2.mimecast.com [207.211.31.81])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-SHA384 (256/256 bits))
	(No client certificate requested)
	by mimecast-mx02.redhat.com (Postfix) with ESMTPS id 04FA98007C9
	for <cluster-devel@redhat.com>; Fri, 10 Apr 2020 03:47:36 +0000 (UTC)
Received: from mail.kernel.org (mail.kernel.org [198.145.29.99]) (Using TLS)
	by relay.mimecast.com with ESMTP id us-mta-511-MbcRgcU6OrqOkGS-eYWe4g-1;
	Thu, 09 Apr 2020 23:47:31 -0400
X-MC-Unique: MbcRgcU6OrqOkGS-eYWe4g-1
...
X-MIME-Autoconverted: from quoted-printable to 8bit by
	lists01.pubmisc.prod.ext.phx2.redhat.com id 03A3lcx2016734
X-loop: cluster-devel@redhat.com
Cc: Sasha Levin <sashal@kernel.org>, cluster-devel@redhat.com
Subject: [Cluster-devel] [PATCH AUTOSEL 5.6 45/68] gfs2: Do log_flush in
...
--- a/fs/gfs2/log.c
+++ b/fs/gfs2/log.c
@@ -512,7 +512,7 @@ static void log_pull_tail(struct gfs2_sbd *sdp, unsigne=
d int new_tail)
 }
=20
=20
