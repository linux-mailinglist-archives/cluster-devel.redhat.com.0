...
Received: from us-smtp-1.mimecast.com (us-smtp-1.mimecast.com [207.211.31.81])
	by mail.lfdr.de (Postfix) with ESMTP id B889D1A80CC
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	...
	bh=eSgqbv+l63F8Q9999T1P1niYhgL5+Sonmt22lroG2b8=;
	b=gufmL/XKB7EgUdR8CezvCoElOdUCbpJIkNDnhfCsNEdCLACd/UmwOyKttkt/xVxIilBoA4
	rh5ksPoXl41LCp3VbD7UNpGLAIqVseKvaa86Ho6VsUyO2dV42YFwwfBIUtPun5M8GZ56hW
	v6jfpr5lAaKA2PumIp8Awu1MIIjHam0=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-447-YQiycutyNKGhd2Jha8KVDg-1; Tue, 14 Apr 2020 11:03:01 -0400
X-MC-Unique: YQiycutyNKGhd2Jha8KVDg-1
Received: from smtp.corp.redhat.com (int-mx05.intmail.prod.int.phx2.redhat.com [10.5.11.15])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by mimecast-mx01.redhat.com (Postfix) with ESMTPS id C634D108838D;
	Tue, 14 Apr 2020 15:02:57 +0000 (UTC)
Received: from colo-mx.corp.redhat.com (colo-mx01.intmail.prod.int.phx2.redhat.com [10.5.11.20])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id AED7F11A026;
	Tue, 14 Apr 2020 15:02:57 +0000 (UTC)
Received: from lists01.pubmisc.prod.ext.phx2.redhat.com (lists01.pubmisc.prod.ext.phx2.redhat.com [10.5.19.33])
	by colo-mx.corp.redhat.com (Postfix) with ESMTP id 8D91518089CD;
	Tue, 14 Apr 2020 15:02:57 +0000 (UTC)
Received: from smtp.corp.redhat.com (int-mx03.intmail.prod.int.rdu2.redhat.com
	[10.11.54.3])
	by lists01.pubmisc.prod.ext.phx2.redhat.com (8.13.8/8.13.8) with ESMTP
	id 03EF2oWx014754 for <cluster-devel@listman.util.phx.redhat.com>;
	Tue, 14 Apr 2020 11:02:50 -0400
Received: by smtp.corp.redhat.com (Postfix)
	id 26B9A10D14FE; Tue, 14 Apr 2020 15:02:50 +0000 (UTC)
Delivered-To: cluster-devel@redhat.com
Received: from mimecast-mx02.redhat.com
	(mimecast02.extmail.prod.ext.rdu2.redhat.com [10.11.55.18])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id 22C0D10D16BB
	for <cluster-devel@redhat.com>; Tue, 14 Apr 2020 15:02:47 +0000 (UTC)
Received: from us-smtp-1.mimecast.com (us-smtp-delivery-1.mimecast.com
	[207.211.31.120])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-SHA384 (256/256 bits))
	(No client certificate requested)
	by mimecast-mx02.redhat.com (Postfix) with ESMTPS id 4CFA08007DC
	for <cluster-devel@redhat.com>; Tue, 14 Apr 2020 15:02:47 +0000 (UTC)
Received: from bombadil.infradead.org (bombadil.infradead.org
	[198.137.202.133]) (Using TLS) by relay.mimecast.com with ESMTP id
	us-mta-393-uuFDwuGyN5qocK1prnwryA-1; Tue, 14 Apr 2020 11:02:44 -0400
X-MC-Unique: uuFDwuGyN5qocK1prnwryA-1
...
X-MIME-Autoconverted: from quoted-printable to 8bit by
	lists01.pubmisc.prod.ext.phx2.redhat.com id 03EF2oWx014754
...
Subject: [Cluster-devel] [PATCH v11 22/25] f2fs: Convert from readpages to
	readahead
...
--- a/fs/f2fs/data.c
+++ b/fs/f2fs/data.c
@@ -2178,8 +2178,7 @@ int f2fs_read_multi_pages(struct compress_ctx *cc, st=
ruct bio **bio_ret,
  * from read-ahead.
  */
...
@@ -2197,6 +2196,7 @@ static int f2fs_mpage_readpages(struct address_space =
*mapping,
...
+=09unsigned nr_pages =3D rac ? readahead_count(rac) : 1;
 ...
 =09int ret =3D 0;
=20
@@ -2210,15 +2210,9 @@ static int f2fs_mpage_readpages(struct address_space=
 *mapping,
...
@@ -2228,7 +2222,7 @@ static int f2fs_mpage_readpages(struct address_space =
*mapping,
...
@@ -2251,7 +2245,7 @@ static int f2fs_mpage_readpages(struct address_space =
*mapping,
 #endif
=20
...
+=09=09=09=09=09&bio, &last_block_in_bio, rac);
 ...
 #ifdef CONFIG_F2FS_FS_COMPRESSION
 set_error_page:
@@ -2260,8 +2254,10 @@ static int f2fs_mpage_readpages(struct address_space=
 *mapping,
...
=20
 #ifdef CONFIG_F2FS_FS_COMPRESSION
@@ -2271,16 +2267,15 @@ static int f2fs_mpage_readpages(struct address_spac=
e *mapping,
 =09=09=09=09ret =3D f2fs_read_multi_pages(&cc, &bio,
 =09=09=09=09=09=09=09max_nr_pages,
 =09=09=09=09=09=09=09&last_block_in_bio,
...
@@ -2299,28 +2294,24 @@ static int f2fs_read_data_page(struct file *file, s=
truct page *page)
