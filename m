...
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	by mail.lfdr.de (Postfix) with ESMTPS id B6FE9631683
	for <lists+cluster-devel@lfdr.de>; Sun, 20 Nov 2022 22:00:29 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1668978028;
	h=from:from:sender:sender:reply-to:subject:subject:date:date:
	 message-id:message-id:to:to:cc:cc:mime-version:mime-version:
	 content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:list-id:list-help:
	 list-unsubscribe:list-subscribe:list-post;
	bh=kryREdHPxV4+mJPOOnLdZIjE3cY0LSvSRFzMU5mNvOk=;
	b=N7rt5qY2fCLUK8218lgmjKP2KMa6xnJt/L1zN67hAzt4W7uCjXHtuj2CJKHuvMWrhsXoHg
	vaP+u9OpsfE94A20PJIQ5RPu6ApxCCFJQZqs4PcV18+zLx111DcrNBYyZQGG3+jX0NistW
	MS3KByHlrP44F1VwddPryAH1Dc8QadA=
Received: from mimecast-mx02.redhat.com (mx3-rdu2.redhat.com
 [66.187.233.73]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-662-ddPc9vpSMmuXButUdvUxqg-1; Sun, 20 Nov 2022 16:00:25 -0500
X-MC-Unique: ddPc9vpSMmuXButUdvUxqg-1
Received: from smtp.corp.redhat.com (int-mx09.intmail.prod.int.rdu2.redhat.com [10.11.54.9])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by mimecast-mx02.redhat.com (Postfix) with ESMTPS id 851B73C0D866;
	Sun, 20 Nov 2022 21:00:24 +0000 (UTC)
Received: from mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com [10.30.29.100])
	by smtp.corp.redhat.com (Postfix) with ESMTP id 5D5A74B3FC8;
	Sun, 20 Nov 2022 21:00:22 +0000 (UTC)
Received: from mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (localhost [IPv6:::1])
	by mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (Postfix) with ESMTP id C2CE7194658C;
	Sun, 20 Nov 2022 21:00:19 +0000 (UTC)
X-Original-To: cluster-devel@listman.corp.redhat.com
Delivered-To: cluster-devel@listman.corp.redhat.com
Received: from smtp.corp.redhat.com (int-mx09.intmail.prod.int.rdu2.redhat.com
 [10.11.54.9])
 by mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (Postfix) with
 ESMTP id 45AC91946587 for <cluster-devel@listman.corp.redhat.com>;
 Sun, 20 Nov 2022 21:00:18 +0000 (UTC)
Received: by smtp.corp.redhat.com (Postfix)
 id 12DA84B3FC8; Sun, 20 Nov 2022 21:00:18 +0000 (UTC)
Delivered-To: cluster-devel@redhat.com
Received: from mimecast-mx02.redhat.com
 (mimecast04.extmail.prod.ext.rdu2.redhat.com [10.11.55.20])
 by smtp.corp.redhat.com (Postfix) with ESMTPS id 09A3B4B3FC6
 for <cluster-devel@redhat.com>; Sun, 20 Nov 2022 21:00:18 +0000 (UTC)
Received: from us-smtp-1.mimecast.com (us-smtp-1.mimecast.com [207.211.31.81])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256
 bits)) (No client certificate requested)
 by mimecast-mx02.redhat.com (Postfix) with ESMTPS id DA710101A528
 for <cluster-devel@redhat.com>; Sun, 20 Nov 2022 21:00:17 +0000 (UTC)
Received: from dfw.source.kernel.org (dfw.source.kernel.org
 [139.178.84.217]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-231-_epYNssWPASUgy0_eZ_BRQ-1; Sun, 20 Nov 2022 16:00:13 -0500
X-MC-Unique: _epYNssWPASUgy0_eZ_BRQ-1
...
Subject: [Cluster-devel] [PATCH] filelock: move file locking definitions to
...
-
 ...
 {
 =09return f->f_inode;
@@ -1353,11 +1027,6 @@ static inline struct dentry *file_dentry(const struc=
t file *file)
