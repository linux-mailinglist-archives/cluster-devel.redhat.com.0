...
Received: from mx1.redhat.com (mx1.redhat.com [209.132.183.28])
	by mail.lfdr.de (Postfix) with ESMTPS id 01E9C7B02C
	for <lists+cluster-devel@lfdr.de>; Tue, 30 Jul 2019 19:35:30 +0200 (CEST)
Received: from smtp.corp.redhat.com (int-mx01.intmail.prod.int.phx2.redhat.com [10.5.11.11])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by mx1.redhat.com (Postfix) with ESMTPS id E459E3082E57;
	Tue, 30 Jul 2019 17:35:27 +0000 (UTC)
Received: from colo-mx.corp.redhat.com (colo-mx01.intmail.prod.int.phx2.redhat.com [10.5.11.20])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id 406CA600CC;
	Tue, 30 Jul 2019 17:35:25 +0000 (UTC)
Received: from lists01.pubmisc.prod.ext.phx2.redhat.com (lists01.pubmisc.prod.ext.phx2.redhat.com [10.5.19.33])
	by colo-mx.corp.redhat.com (Postfix) with ESMTP id 6C91018089C8;
	Tue, 30 Jul 2019 17:35:22 +0000 (UTC)
Received: from smtp.corp.redhat.com (int-mx02.intmail.prod.int.phx2.redhat.com
	[10.5.11.12])
	by lists01.pubmisc.prod.ext.phx2.redhat.com (8.13.8/8.13.8) with ESMTP
	id x6UHToiP010646 for <cluster-devel@listman.util.phx.redhat.com>;
	Tue, 30 Jul 2019 13:29:50 -0400
Received: by smtp.corp.redhat.com (Postfix)
	id 9A64D60C47; Tue, 30 Jul 2019 17:29:50 +0000 (UTC)
Delivered-To: cluster-devel@redhat.com
Received: from mx1.redhat.com (ext-mx19.extmail.prod.ext.phx2.redhat.com
	[10.5.110.48])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id 93A8960BEC
	for <cluster-devel@redhat.com>; Tue, 30 Jul 2019 17:29:48 +0000 (UTC)
Received: from mail-pg1-f196.google.com (mail-pg1-f196.google.com
	[209.85.215.196])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by mx1.redhat.com (Postfix) with ESMTPS id 14F0F307D853
	for <cluster-devel@redhat.com>; Tue, 30 Jul 2019 17:29:41 +0000 (UTC)
Received: by mail-pg1-f196.google.com with SMTP id f20so21186603pgj.0
	for <cluster-devel@redhat.com>; Tue, 30 Jul 2019 10:29:41 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
	...
	bh=hpXePiRxXfQ6sClI29050n6F2wnM+ayz6+4t+YYSnqM=;
	b=
X-Gm-Message-State: APjAAAWlhdS4qN5NnKJqNUVa0ocN9CcYP9DSpqhE/fztYQq64srEjowD
	zbbjpmTXyQr/Dk37N4qksOQ=
...
Received: from nebulus.mtv.corp.google.com
	...
	o129sm39856293pfg.1.2019.07.30.10.29.37
...
X-Greylist: Sender IP whitelisted, not delayed by milter-greylist-4.5.16
	...
	Tue, 30 Jul 2019 17:29:41 +0000 (UTC)
X-Greylist: inspected by milter-greylist-4.5.16 (mx1.redhat.com [10.5.110.48]);
	Tue, 30 Jul 2019 17:29:41 +0000 (UTC) for IP:'209.85.215.196'
	DOMAIN:'mail-pg1-f196.google.com'
	HELO:'mail-pg1-f196.google.com' FROM:'salyzyn@android.com' RCPT:''
X-RedHat-Spam-Score: -0.099  (DKIMWL_WL_HIGH, DKIM_SIGNED, DKIM_VALID,
	...
	mail-pg1-f196.google.com <salyzyn@android.com>
X-Scanned-By: MIMEDefang 2.84 on 10.5.110.48
X-Scanned-By: MIMEDefang 2.79 on 10.5.11.12
X-loop: cluster-devel@redhat.com
X-Mailman-Approved-At: Tue, 30 Jul 2019 13:35:17 -0400
Cc: Latchesar Ionkov <lucho@ionkov.net>, Dave Kleikamp <shaggy@kernel.org>,
	...
	Hugh Dickins <hughd@google.com>, cluster-devel@redhat.com,
...
Subject: [Cluster-devel] [PATCH v12 2/5] Add flags option to get xattr
...
X-Greylist: Sender IP whitelisted, not delayed by milter-greylist-4.5.16 (mx1.redhat.com [10.5.110.46]); Tue, 30 Jul 2019 17:35:28 +0000 (UTC)
