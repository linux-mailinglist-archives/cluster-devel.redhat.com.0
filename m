...
Received: from us-smtp-1.mimecast.com (us-smtp-1.mimecast.com [205.139.110.61])
	by mail.lfdr.de (Postfix) with ESMTP id 5B4DB1A80D5
	for <lists+cluster-devel@lfdr.de>; Tue, 14 Apr 2020 17:03:06 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1586876585;
	...
	bh=kdTaNb9GrzVnBnolloP4HXQfTW9EchTNahU5GouPXW0=;
	b=jGmvkWl+5v7iu0lnO44Ti/wqevzStG1mxidqCiTZDJWUKI10t5LCDZSZZFwF3Ns1s4q/Wf
	v49vNGJHWovBfu/VDK2QsQ53K1hVfewhk5OMPlH2nvRB5vqh6YUylTyoCTpcbzRLnquCGE
	z4qbf9prxbJbxa+hJwIJIUYDXy/RZ9Y=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-294--UkJ_H9nMx6PyufngMTwcA-1; Tue, 14 Apr 2020 11:03:02 -0400
X-MC-Unique: -UkJ_H9nMx6PyufngMTwcA-1
Received: from smtp.corp.redhat.com (int-mx03.intmail.prod.int.phx2.redhat.com [10.5.11.13])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by mimecast-mx01.redhat.com (Postfix) with ESMTPS id CAA9A10CE78D;
	Tue, 14 Apr 2020 15:02:59 +0000 (UTC)
Received: from colo-mx.corp.redhat.com (colo-mx01.intmail.prod.int.phx2.redhat.com [10.5.11.20])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id B64DF9F9B4;
	Tue, 14 Apr 2020 15:02:59 +0000 (UTC)
Received: from lists01.pubmisc.prod.ext.phx2.redhat.com (lists01.pubmisc.prod.ext.phx2.redhat.com [10.5.19.33])
	by colo-mx.corp.redhat.com (Postfix) with ESMTP id 9127018089C8;
	Tue, 14 Apr 2020 15:02:59 +0000 (UTC)
Received: from smtp.corp.redhat.com (int-mx05.intmail.prod.int.rdu2.redhat.com
	[10.11.54.5])
	by lists01.pubmisc.prod.ext.phx2.redhat.com (8.13.8/8.13.8) with ESMTP
	id 03EF2nF5014745 for <cluster-devel@listman.util.phx.redhat.com>;
	Tue, 14 Apr 2020 11:02:49 -0400
Received: by smtp.corp.redhat.com (Postfix)
	id AFF19F1000; Tue, 14 Apr 2020 15:02:49 +0000 (UTC)
Delivered-To: cluster-devel@redhat.com
Received: from mimecast-mx02.redhat.com
	(mimecast02.extmail.prod.ext.rdu2.redhat.com [10.11.55.18])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id ABCFFEC4AA
	for <cluster-devel@redhat.com>; Tue, 14 Apr 2020 15:02:49 +0000 (UTC)
Received: from us-smtp-1.mimecast.com (us-smtp-1.mimecast.com [205.139.110.61])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-SHA384 (256/256 bits))
	(No client certificate requested)
	by mimecast-mx02.redhat.com (Postfix) with ESMTPS id 8E931802064
	for <cluster-devel@redhat.com>; Tue, 14 Apr 2020 15:02:49 +0000 (UTC)
Received: from bombadil.infradead.org (bombadil.infradead.org
	[198.137.202.133]) (Using TLS) by relay.mimecast.com with ESMTP id
	us-mta-418-XQGDWrV0Miq-MikRi5-tMg-1; Tue, 14 Apr 2020 11:02:47 -0400
X-MC-Unique: XQGDWrV0Miq-MikRi5-tMg-1
...
X-MIME-Autoconverted: from quoted-printable to 8bit by
	lists01.pubmisc.prod.ext.phx2.redhat.com id 03EF2nF5014745
...
Subject: [Cluster-devel] [PATCH v11 16/25] fs: Convert mpage_readpages to
	mpage_readahead
...
--- a/fs/block_dev.c
+++ b/fs/block_dev.c
@@ -615,10 +615,9 @@ static int blkdev_readpage(struct file * file, struct =
page * page)
...
ping,
@@ -2076,7 +2075,7 @@ static int blkdev_writepages(struct address_space *ma=
pping,
=20
...
--- a/fs/exfat/inode.c
+++ b/fs/exfat/inode.c
@@ -372,10 +372,9 @@ static int exfat_readpage(struct file *file, struct pa=
ge *page)
...
g,
-=09=09struct list_head *pages, unsigned int nr_pages)
...
c)
@@ -502,7 +501,7 @@ int exfat_block_truncate_page(struct inode *inode, loff=
_t from)
=20
 static const struct address_space_operations exfat_aops =3D {
 =09.readpage=09=3D exfat_readpage,
-=09.readpages=09=3D exfat_readpages,
+=09.readahead=09=3D exfat_readahead,
 =09.writepage=09=3D exfat_writepage,
 =09.writepages=09=3D exfat_writepages,
 =09.write_begin=09=3D exfat_write_begin,
diff --git a/fs/ext2/inode.c b/fs/ext2/inode.c
index c885cf7d724b..2875c0a705b5 100644
--- a/fs/ext2/inode.c
+++ b/fs/ext2/inode.c
@@ -877,11 +877,9 @@ static int ext2_readpage(struct file *file, struct pag=
e *page)
...
=20
 static int
@@ -967,7 +965,7 @@ ext2_dax_writepages(struct address_space *mapping, stru=
...
@@ -590,31 +590,24 @@ int gfs2_internal_read(struct gfs2_inode *ip, char *b=
uf, loff_t *pos,
...
@@ -847,7 +840,7 @@ static const struct address_space_operations gfs2_jdata=
_aops =3D {
...
--- a/fs/hpfs/file.c
+++ b/fs/hpfs/file.c
@@ -125,10 +125,9 @@ static int hpfs_writepage(struct page *page, struct wr=
iteback_control *wbc)
...
@@ -198,7 +197,7 @@ static int hpfs_fiemap(struct inode *inode, struct fiem=
...
@@ -367,7 +367,7 @@ iomap_readpage(struct page *page, const struct iomap_op=
s *ops)
 =09}
=20
 =09/*
...
@@ -1198,7 +1197,7 @@ static sector_t _isofs_bmap(struct address_space *map=
ping, sector_t block)
=20
...
+ * support function for mpage_readahead.  The fs supplied get_block might
  ...
  * to get_block.
@@ -338,13 +338,8 @@ static struct bio *do_mpage_readpage(struct mpage_read=
page_args *args)
 }
=20
 /**
...
+ * @rac: Describes which pages to read.
 ...
 and
@@ -381,36 +376,25 @@ static struct bio *do_mpage_readpage(struct mpage_rea=
dpage_args *args)
  *
...
--- a/fs/nilfs2/inode.c
+++ b/fs/nilfs2/inode.c
@@ -145,18 +145,9 @@ static int nilfs_readpage(struct file *file, struct pa=
ge *page)
...
--- a/fs/ocfs2/aops.c
+++ b/fs/ocfs2/aops.c
@@ -350,14 +350,11 @@ static int ocfs2_readpage(struct file *file, struct p=
age *page)
...
-=09=09goto out_unlock;
+=09if (readahead_pos(rac) >=3D i_size_read(inode))
+=09=09goto out_up;
=20
...
@@ -2474,7 +2466,7 @@ static ssize_t ocfs2_direct_IO(struct kiocb *iocb, st=
ruct iov_iter *iter)
=20
...
--- a/fs/omfs/file.c
+++ b/fs/omfs/file.c
@@ -289,10 +289,9 @@ static int omfs_readpage(struct file *file, struct pag=
e *page)
...
=20
 /*
@@ -3434,7 +3432,7 @@ int reiserfs_setattr(struct dentry *dentry, struct ia=
ttr *attr)
...
--- a/mm/migrate.c
+++ b/mm/migrate.c
@@ -1032,7 +1032,7 @@ static int __unmap_and_move(struct page *page, struct=
 page *newpage,
