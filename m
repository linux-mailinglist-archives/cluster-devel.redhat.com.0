...
Received: from us-smtp-1.mimecast.com (us-smtp-delivery-1.mimecast.com [205.139.110.120])
	by mail.lfdr.de (Postfix) with ESMTP id 245BCFE03F
	for <lists+cluster-devel@lfdr.de>; Fri, 15 Nov 2019 15:39:30 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1573828768;
	h=from:from:sender:sender:reply-to:subject:subject:date:date:
	 message-id:message-id:to:to:cc:mime-version:mime-version:
	 content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:list-id:list-help:list-unsubscribe:
	 list-subscribe:list-post; bh=+ntWVauhf96LUSmPcrvX26ohqzgadnN7zlZATOi5O9Q=;
	b=FA+/J2Kl2zGz32dWMir0RcbaFzyiJK8Xyw0VsO3xNpgLhaPvnc+6Kd0QoP3d4s0lg7T0ih
	X3hL9relwbP7hVl81L+/EopRLfer6HMC6tZ/fpWF8gEBblmk5lJBSGxdIG0cpGUJ9matVO
	+iCuQyllb8zPFoWyMD7ugS6uJC3CMIQ=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-188-zG-sQnDSOjCa_56Ne2NVnA-1; Fri, 15 Nov 2019 09:39:27 -0500
Received: from smtp.corp.redhat.com (int-mx07.intmail.prod.int.phx2.redhat.com [10.5.11.22])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by mimecast-mx01.redhat.com (Postfix) with ESMTPS id B86B8593A2;
	Fri, 15 Nov 2019 14:39:24 +0000 (UTC)
Received: from colo-mx.corp.redhat.com (colo-mx01.intmail.prod.int.phx2.redhat.com [10.5.11.20])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id AF1BC1036C86;
	Fri, 15 Nov 2019 14:39:23 +0000 (UTC)
Received: from lists01.pubmisc.prod.ext.phx2.redhat.com (lists01.pubmisc.prod.ext.phx2.redhat.com [10.5.19.33])
	by colo-mx.corp.redhat.com (Postfix) with ESMTP id 5FE1318089CD;
	Fri, 15 Nov 2019 14:39:20 +0000 (UTC)
Received: from smtp.corp.redhat.com (int-mx04.intmail.prod.int.phx2.redhat.com
	[10.5.11.14])
	by lists01.pubmisc.prod.ext.phx2.redhat.com (8.13.8/8.13.8) with ESMTP
	id xAFEdFXU002432 for <cluster-devel@listman.util.phx.redhat.com>;
	Fri, 15 Nov 2019 09:39:15 -0500
Received: by smtp.corp.redhat.com (Postfix)
	id 8C6695DAB8; Fri, 15 Nov 2019 14:39:15 +0000 (UTC)
Delivered-To: cluster-devel@redhat.com
Received: from colo-mx.corp.redhat.com
	(colo-mx02.intmail.prod.int.phx2.redhat.com [10.5.11.21])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id 86F7E5ED4E
	for <cluster-devel@redhat.com>; Fri, 15 Nov 2019 14:39:13 +0000 (UTC)
Received: from zmail21.collab.prod.int.phx2.redhat.com
	(zmail21.collab.prod.int.phx2.redhat.com [10.5.83.24])
	by colo-mx.corp.redhat.com (Postfix) with ESMTP id 17F6E4BB5C
	for <cluster-devel@redhat.com>; Fri, 15 Nov 2019 14:39:13 +0000 (UTC)
Date: Fri, 15 Nov 2019 09:39:13 -0500 (EST)
From: Bob Peterson <rpeterso@redhat.com>
To: cluster-devel <cluster-devel@redhat.com>
Message-ID: <1617710442.30232713.1573828753028.JavaMail.zimbra@redhat.com>
In-Reply-To: <1660556917.30232558.1573828656613.JavaMail.zimbra@redhat.com>
MIME-Version: 1.0
X-Originating-IP: [10.3.116.60, 10.4.195.19]
Thread-Topic: gfs2: Introduce function gfs2_withdrawn
Thread-Index: JrxaFuVnds/rmfBY+7SjKXmUKDbdFg==
X-Scanned-By: MIMEDefang 2.79 on 10.5.11.14
X-loop: cluster-devel@redhat.com
Subject: [Cluster-devel] [GFS2 PATCH v2] gfs2: Introduce function
	gfs2_withdrawn
...
X-MC-Unique: zG-sQnDSOjCa_56Ne2NVnA-1
...
--- a/fs/gfs2/util.h
+++ b/fs/gfs2/util.h
@@ -164,6 +164,15 @@ static inline unsigned int gfs2_tune_get_i(struct gfs2=
_tune *gt,
 =09return x;
 }
=20
