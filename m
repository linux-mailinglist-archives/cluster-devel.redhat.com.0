...
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	by mail.lfdr.de (Postfix) with ESMTPS id 049A24C1996
	for <lists+cluster-devel@lfdr.de>; Wed, 23 Feb 2022 18:11:22 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	...
	bh=7rPi9EJ/zN81HE2xGy6hAMXq3USa3cXgsjVcEt6mMko=;
	b=f1Em9Gypkcy8l5LIwIe1dCnrzn7ZjgKo6EiNokg+1iPkdcuqdX4VeioP74huaRVUXfZo3E
	uKXCVShpCenkIzhfKdaNGWQ7OY8FFiC+H69+jRYIJdBRsQ7m7hPqiP23G5acduc7HKYuz1
	s4nvvjjCODqG+A598lh2HLp6gmvz4B8=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-675-rl_aY3CKNJeaJFcZ-JGpbA-1; Wed, 23 Feb 2022 12:11:18 -0500
X-MC-Unique: rl_aY3CKNJeaJFcZ-JGpbA-1
Received: from smtp.corp.redhat.com (int-mx03.intmail.prod.int.phx2.redhat.com [10.5.11.13])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by mimecast-mx01.redhat.com (Postfix) with ESMTPS id AAB561091DA3;
	Wed, 23 Feb 2022 17:11:15 +0000 (UTC)
Received: from colo-mx.corp.redhat.com (colo-mx02.intmail.prod.int.phx2.redhat.com [10.5.11.21])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id A23AF86589;
	Wed, 23 Feb 2022 17:11:14 +0000 (UTC)
Received: from lists01.pubmisc.prod.ext.phx2.redhat.com (lists01.pubmisc.prod.ext.phx2.redhat.com [10.5.19.33])
	by colo-mx.corp.redhat.com (Postfix) with ESMTP id 33B134EE45;
	Wed, 23 Feb 2022 17:11:14 +0000 (UTC)
Received: from smtp.corp.redhat.com (int-mx06.intmail.prod.int.phx2.redhat.com
	[10.5.11.16])
	by lists01.pubmisc.prod.ext.phx2.redhat.com (8.13.8/8.13.8) with ESMTP
	id 21NH8pZm009253 for <cluster-devel@listman.util.phx.redhat.com>;
	Wed, 23 Feb 2022 12:08:52 -0500
Received: by smtp.corp.redhat.com (Postfix)
	id EB7CC838E9; Wed, 23 Feb 2022 17:08:51 +0000 (UTC)
Delivered-To: cluster-devel@redhat.com
Received: from fs-i40c-03.fs.lab.eng.bos.redhat.com
	(fs-i40c-03.fs.lab.eng.bos.redhat.com [10.16.224.23])
	by smtp.corp.redhat.com (Postfix) with ESMTP id 7D7AF838E6;
	Wed, 23 Feb 2022 17:08:51 +0000 (UTC)
From: Alexander Aring <aahringo@redhat.com>
To: teigland@redhat.com
Date: Wed, 23 Feb 2022 12:08:23 -0500
Message-Id: <20220223170829.830864-4-aahringo@redhat.com>
...
Subject: [Cluster-devel] [PATCH/RFC dlm/next 3/9] fs: dlm: use __le types
	for dlm header
...
index bdb51d209ba2..c9b164f23d40 100644
--- a/fs/dlm/lock.c
+++ b/fs/dlm/lock.c
...
+		  lkb->lkb_remid, mstype, lkb->lkb_flags);
  ...
  out_del:
@@ -3563,10 +3563,10 @@ static int _create_message(struct dlm_ls *ls, int mb_len,
...
+	ms->m_header.h_length = cpu_to_le16(mb_len);
 	...
 	ms->m_type = mstype;
@@ -3860,7 +3860,7 @@ static int send_lookup_reply(struct dlm_ls *ls, struct dlm_message *ms_in,
...
+	int error, nodeid = le32_to_cpu(ms_in->m_header.h_nodeid);
 	...
 	if (error)
@@ -3899,7 +3899,8 @@ static void receive_flags_reply(struct dlm_lkb *lkb, struct dlm_message *ms)
...
@@ -3933,7 +3934,7 @@ static void fake_astfn(void *astparam)
...
@@ -3981,7 +3982,7 @@ static int receive_unlock_args(struct dlm_ls *ls, struct dlm_lkb *lkb,
...
@@ -3990,7 +3991,7 @@ static void setup_stub_lkb(struct dlm_ls *ls, struct dlm_message *ms)
...
@@ -4104,7 +4105,7 @@ static int receive_request(struct dlm_ls *ls, struct dlm_message *ms)
 	int from_nodeid;
 	int error, namelen = 0;
...
+	from_nodeid = le32_to_cpu(ms->m_header.h_nodeid);
 	...
 	if (error)
@@ -4204,7 +4205,7 @@ static int receive_convert(struct dlm_ls *ls, struct dlm_message *ms)
...
+			  le32_to_cpu(ms->m_header.h_nodeid), ms->m_lkid);
 		...
 		dlm_put_lkb(lkb);
 		goto fail;
@@ -4258,7 +4259,7 @@ static int receive_unlock(struct dlm_ls *ls, struct dlm_message *ms)
...
+			  le32_to_cpu(ms->m_header.h_nodeid), ms->m_lkid);
 		...
 		dlm_put_lkb(lkb);
 		goto fail;
@@ -4395,7 +4396,7 @@ static void receive_lookup(struct dlm_ls *ls, struct dlm_message *ms)
 {
...
@@ -4418,7 +4419,7 @@ static void receive_remove(struct dlm_ls *ls, struct dlm_message *ms)
 	uint32_t hash, b;
...
@@ -4509,7 +4510,7 @@ static int receive_request_reply(struct dlm_ls *ls, struct dlm_message *ms)
 	struct dlm_lkb *lkb;
 	struct dlm_rsb *r;
...
+	int from_nodeid = le32_to_cpu(ms->m_header.h_nodeid);
 	...
 	if (error)
@@ -4661,8 +4662,8 @@ static void __receive_convert_reply(struct dlm_rsb *r, struct dlm_lkb *lkb,
...
@@ -4841,8 +4842,8 @@ static void receive_lookup_reply(struct dlm_ls *ls, struct dlm_message *ms)
...
@@ -4854,7 +4855,7 @@ static void receive_lookup_reply(struct dlm_ls *ls, struct dlm_message *ms)
...
+			  lkb->lkb_id, le32_to_cpu(ms->m_header.h_nodeid));
 		...
 		r->res_nodeid = -1;
 		lkb->lkb_nodeid = -1;
@@ -4888,10 +4889,10 @@ static void _receive_message(struct dlm_ls *ls, struct dlm_message *ms,
 {
 	int error = 0, noent = 0;
...
@@ -4985,11 +4986,13 @@ static void _receive_message(struct dlm_ls *ls, struct dlm_message *ms,
...
@@ -4999,7 +5002,7 @@ static void _receive_message(struct dlm_ls *ls, struct dlm_message *ms,
 	if (error == -EINVAL) {
...
@@ -5066,18 +5069,20 @@ void dlm_receive_buffer(union dlm_packet *p, int nodeid)
 		return;
 	}
...
@@ -5107,7 +5112,7 @@ static void recover_convert_waiter(struct dlm_ls *ls, struct dlm_lkb *lkb,
...
@@ -5229,7 +5234,7 @@ void dlm_recover_waiters_pre(struct dlm_ls *ls)
 			ms_stub->m_flags = DLM_IFL_STUB_MS;
...
+			ms_stub->m_header.h_nodeid = cpu_to_le32(lkb->lkb_nodeid);
 			...
 			dlm_put_lkb(lkb);
 			break;
@@ -5240,7 +5245,7 @@ void dlm_recover_waiters_pre(struct dlm_ls *ls)
 			ms_stub->m_flags = DLM_IFL_STUB_MS;
...
+			ms_stub->m_header.h_nodeid = cpu_to_le32(lkb->lkb_nodeid);
 			...
 			dlm_put_lkb(lkb);
 			break;
@@ -5605,7 +5610,7 @@ static int receive_rcom_lock_args(struct dlm_ls *ls, struct dlm_lkb *lkb,
 {
...
@@ -5620,8 +5625,8 @@ static int receive_rcom_lock_args(struct dlm_ls *ls, struct dlm_lkb *lkb,
...
@@ -5657,7 +5662,7 @@ int dlm_recover_master_copy(struct dlm_ls *ls, struct dlm_rcom *rc)
 	struct dlm_rsb *r;
 	struct dlm_lkb *lkb;
 	uint32_t remid = 0;
...
@@ -5747,7 +5752,8 @@ int dlm_recover_process_copy(struct dlm_ls *ls, struct dlm_rcom *rc)
...
@@ -5757,7 +5763,8 @@ int dlm_recover_process_copy(struct dlm_ls *ls, struct dlm_rcom *rc)
...
+			  result);
 		...
 		unlock_rsb(r);
 		put_rsb(r);
@@ -5772,7 +5779,8 @@ int dlm_recover_process_copy(struct dlm_ls *ls, struct dlm_rcom *rc)
...
+			  result);
 		...
 		goto out;
@@ -5782,7 +5790,8 @@ int dlm_recover_process_copy(struct dlm_ls *ls, struct dlm_rcom *rc)
 		break;
 	default:
