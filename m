...
Received: from mx1.redhat.com (mx1.redhat.com [209.132.183.28])
	by mail.lfdr.de (Postfix) with ESMTPS id 3BD2F1FB1D
	for <lists+cluster-devel@lfdr.de>; Wed, 15 May 2019 21:40:04 +0200 (CEST)
Received: from smtp.corp.redhat.com (int-mx08.intmail.prod.int.phx2.redhat.com [10.5.11.23])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by mx1.redhat.com (Postfix) with ESMTPS id C4968C09AD1F;
	Wed, 15 May 2019 19:40:02 +0000 (UTC)
Received: from colo-mx.corp.redhat.com (colo-mx02.intmail.prod.int.phx2.redhat.com [10.5.11.21])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id 8FA6719C71;
	Wed, 15 May 2019 19:40:02 +0000 (UTC)
Received: from lists01.pubmisc.prod.ext.phx2.redhat.com (lists01.pubmisc.prod.ext.phx2.redhat.com [10.5.19.33])
	by colo-mx.corp.redhat.com (Postfix) with ESMTP id 2B5545B425;
	Wed, 15 May 2019 19:40:02 +0000 (UTC)
Received: from smtp.corp.redhat.com (int-mx02.intmail.prod.int.phx2.redhat.com
	[10.5.11.12])
	by lists01.pubmisc.prod.ext.phx2.redhat.com (8.13.8/8.13.8) with ESMTP
	id x4FJcTYc029121 for <cluster-devel@listman.util.phx.redhat.com>;
	Wed, 15 May 2019 15:38:29 -0400
Received: by smtp.corp.redhat.com (Postfix)
	id ED4C860FAE; Wed, 15 May 2019 19:38:29 +0000 (UTC)
Delivered-To: cluster-devel@redhat.com
Received: from vishnu.redhat.com (ovpn-116-119.phx2.redhat.com [10.3.116.119])
	by smtp.corp.redhat.com (Postfix) with ESMTP id A811660F9C
	for <cluster-devel@redhat.com>; Wed, 15 May 2019 19:38:29 +0000 (UTC)
From: Bob Peterson <rpeterso@redhat.com>
To: cluster-devel <cluster-devel@redhat.com>
Date: Wed, 15 May 2019 14:38:12 -0500
Message-Id: <20190515193818.7642-20-rpeterso@redhat.com>
...
Subject: [Cluster-devel] [GFS2 v4 PATCH 19/25] gfs2: Force withdraw to
...
X-Greylist: Sender IP whitelisted, not delayed by milter-greylist-4.5.16 (mx1.redhat.com [10.5.110.32]); Wed, 15 May 2019 19:40:03 +0000 (UTC)
...
index f738a7f64285..a5c125e64bf7 100644
--- a/fs/gfs2/glops.c
+++ b/fs/gfs2/glops.c
@@ -32,6 +32,8 @@
...
@@ -511,6 +513,10 @@ static void freeze_go_sync(struct gfs2_glock *gl)
 		if (error) {
...
@@ -585,6 +591,55 @@ static void iopen_go_callback(struct gfs2_glock *gl, bool remote)
 	}
 }
...
@@ -639,6 +694,7 @@ const struct gfs2_glock_operations gfs2_flock_glops = {
...
index b8f6e2fd86ae..7ad8b8dade1f 100644
--- a/fs/gfs2/incore.h
+++ b/fs/gfs2/incore.h
@@ -631,6 +631,9 @@ enum {
 	SDF_FS_FROZEN           = 10,
...
index 8b6e19802a7f..2764d612052d 100644
--- a/fs/gfs2/log.c
+++ b/fs/gfs2/log.c
...
index 110f00024950..319e2d237056 100644
--- a/fs/gfs2/super.c
+++ b/fs/gfs2/super.c
@@ -846,35 +846,52 @@ static void gfs2_dirty_inode(struct inode *inode, int flags)
 /**
...
@@ -914,7 +931,7 @@ static void gfs2_put_super(struct super_block *sb)
...
@@ -931,8 +948,10 @@ static void gfs2_put_super(struct super_block *sb)
...
@@ -1276,7 +1295,7 @@ static int gfs2_remount_fs(struct super_block *sb, int *flags, char *data)
...
index b678412d968a..a3f214ce779e 100644
--- a/fs/gfs2/util.c
+++ b/fs/gfs2/util.c
@@ -14,11 +14,13 @@
