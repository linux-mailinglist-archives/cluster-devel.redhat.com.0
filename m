...
Received: from us-smtp-1.mimecast.com (us-smtp-2.mimecast.com [205.139.110.61])
	by mail.lfdr.de (Postfix) with ESMTP id 78E8115875D
	for <lists+cluster-devel@lfdr.de>; Tue, 11 Feb 2020 02:04:26 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1581383065;
	...
	bh=VMqrvte6WKbbRCVTcdkmGXkvbUSX66Zjlp6p+Vpx89E=;
	b=VYraTJ1uOgeVjCQkD1E26baSB6hPlJA3INSF767F2ULu0CzHnFaskAJANmSKi4hfvmnbxj
	NCBCV08jS+UfiPy3aF0bK4Kw5tE6cry3Gi3GZ+cYiS8QkmkdA4TWISRgYV/6TiJl10a922
	oI/K56a7fagqF/26Bl6S6U9MyC45reI=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-312-sjFb0SuhPQKjKPL-pkXkww-1; Mon, 10 Feb 2020 20:04:14 -0500
Received: from smtp.corp.redhat.com (int-mx03.intmail.prod.int.phx2.redhat.com [10.5.11.13])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by mimecast-mx01.redhat.com (Postfix) with ESMTPS id A037F101FC69;
	Tue, 11 Feb 2020 01:04:12 +0000 (UTC)
Received: from colo-mx.corp.redhat.com (colo-mx02.intmail.prod.int.phx2.redhat.com [10.5.11.21])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id 8B8828EA1C;
	Tue, 11 Feb 2020 01:04:12 +0000 (UTC)
Received: from lists01.pubmisc.prod.ext.phx2.redhat.com (lists01.pubmisc.prod.ext.phx2.redhat.com [10.5.19.33])
	by colo-mx.corp.redhat.com (Postfix) with ESMTP id 6E5B0866D9;
	Tue, 11 Feb 2020 01:04:12 +0000 (UTC)
Received: from smtp.corp.redhat.com (int-mx03.intmail.prod.int.rdu2.redhat.com
	[10.11.54.3])
	by lists01.pubmisc.prod.ext.phx2.redhat.com (8.13.8/8.13.8) with ESMTP
	id 01B147nA019429 for <cluster-devel@listman.util.phx.redhat.com>;
	Mon, 10 Feb 2020 20:04:08 -0500
Received: by smtp.corp.redhat.com (Postfix)
	id D363310EE799; Tue, 11 Feb 2020 01:04:07 +0000 (UTC)
Delivered-To: cluster-devel@redhat.com
Received: from mimecast-mx02.redhat.com
	(mimecast05.extmail.prod.ext.rdu2.redhat.com [10.11.55.21])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id CD92810A50F5
	for <cluster-devel@redhat.com>; Tue, 11 Feb 2020 01:04:05 +0000 (UTC)
Received: from us-smtp-1.mimecast.com (us-smtp-1.mimecast.com [207.211.31.81])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-SHA384 (256/256 bits))
	(No client certificate requested)
	by mimecast-mx02.redhat.com (Postfix) with ESMTPS id 4A9E38001FE
	for <cluster-devel@redhat.com>; Tue, 11 Feb 2020 01:04:05 +0000 (UTC)
Received: from bombadil.infradead.org (bombadil.infradead.org
	[198.137.202.133]) (Using TLS) by relay.mimecast.com with ESMTP id
	us-mta-97-WaRlDMlxO5iPykrcYBgJzA-1; Mon, 10 Feb 2020 20:04:02 -0500
...
MIME-Version: 1.0
X-MC-Unique: WaRlDMlxO5iPykrcYBgJzA-1
X-MC-Unique: sjFb0SuhPQKjKPL-pkXkww-1
X-Scanned-By: MIMEDefang 2.78 on 10.11.54.3
X-MIME-Autoconverted: from quoted-printable to 8bit by
	lists01.pubmisc.prod.ext.phx2.redhat.com id 01B147nA019429
...
Subject: [Cluster-devel] [PATCH v5 06/13] fs: Convert mpage_readpages to
	mpage_readahead
...
=20
 static int
@@ -966,7 +964,7 @@ ext2_dax_writepages(struct address_space *mapping, stru=
...
@@ -980,7 +978,7 @@ const struct address_space_operations ext2_aops =3D {
=20
...
+ * @nr_pages: The number of consecutive pages to read.
 ...
 and
@@ -381,36 +378,25 @@ static struct bio *do_mpage_readpage(struct mpage_rea=
dpage_args *args)
  *
...
@@ -563,7 +549,7 @@ static int __mpage_writepage(struct page *page, struct =
