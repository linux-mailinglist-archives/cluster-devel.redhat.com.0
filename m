...
Received: from us-smtp-1.mimecast.com (us-smtp-delivery-1.mimecast.com [205.139.110.120])
	by mail.lfdr.de (Postfix) with ESMTP id 924AC165095
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	...
	bh=clFreZUDpbI17Z2zL2LLmD6DjX0NHBQUxB/1Eqhp8ig=;
	b=cQIwMzswMOSnmj/Jn6SgYOq5MaOSJ8xqZusohk9uwvZqLqQKP138jiep5/LdwXv5f2mKm8
	D308S6018kLrfZz6tqDbAgU6ybD67LtG9ygTbSYfag4qxfBhP3BVt/F1VRQ13+Rj5nvJ71
	1fYtWWKWYowtXly4i3t0tHoPt1LDmNk=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-226-gPgjxfc_NT6b99C7o8i9TQ-1; Wed, 19 Feb 2020 16:01:27 -0500
Received: from smtp.corp.redhat.com (int-mx05.intmail.prod.int.phx2.redhat.com [10.5.11.15])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by mimecast-mx01.redhat.com (Postfix) with ESMTPS id F1E3A801A16;
	Wed, 19 Feb 2020 21:01:23 +0000 (UTC)
Received: from colo-mx.corp.redhat.com (colo-mx02.intmail.prod.int.phx2.redhat.com [10.5.11.21])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id D68AE91820;
	Wed, 19 Feb 2020 21:01:23 +0000 (UTC)
Received: from lists01.pubmisc.prod.ext.phx2.redhat.com (lists01.pubmisc.prod.ext.phx2.redhat.com [10.5.19.33])
	by colo-mx.corp.redhat.com (Postfix) with ESMTP id B0BCB35B19;
	Wed, 19 Feb 2020 21:01:23 +0000 (UTC)
Received: from smtp.corp.redhat.com (int-mx03.intmail.prod.int.rdu2.redhat.com
	[10.11.54.3])
	by lists01.pubmisc.prod.ext.phx2.redhat.com (8.13.8/8.13.8) with ESMTP
	id 01JL1ITZ001908 for <cluster-devel@listman.util.phx.redhat.com>;
	Wed, 19 Feb 2020 16:01:19 -0500
Received: by smtp.corp.redhat.com (Postfix)
	id CAD0410A85BA; Wed, 19 Feb 2020 21:01:18 +0000 (UTC)
Delivered-To: cluster-devel@redhat.com
Received: from mimecast-mx02.redhat.com
	(mimecast03.extmail.prod.ext.rdu2.redhat.com [10.11.55.19])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id C606510A85B9
	for <cluster-devel@redhat.com>; Wed, 19 Feb 2020 21:01:18 +0000 (UTC)
Received: from us-smtp-1.mimecast.com (us-smtp-delivery-1.mimecast.com
	[207.211.31.120])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-SHA384 (256/256 bits))
	(No client certificate requested)
	by mimecast-mx02.redhat.com (Postfix) with ESMTPS id 9D8EE800313
	for <cluster-devel@redhat.com>; Wed, 19 Feb 2020 21:01:18 +0000 (UTC)
Received: from bombadil.infradead.org (bombadil.infradead.org
	[198.137.202.133]) (Using TLS) by relay.mimecast.com with ESMTP id
	us-mta-325-92zwpJdSMUaMbYm6o-ixow-1; Wed, 19 Feb 2020 16:01:15 -0500
...
MIME-Version: 1.0
X-MC-Unique: 92zwpJdSMUaMbYm6o-ixow-1
X-MC-Unique: gPgjxfc_NT6b99C7o8i9TQ-1
X-Scanned-By: MIMEDefang 2.78 on 10.11.54.3
X-MIME-Autoconverted: from quoted-printable to 8bit by
	lists01.pubmisc.prod.ext.phx2.redhat.com id 01JL1ITZ001908
...
Subject: [Cluster-devel] [PATCH v7 06/24] mm: Rename various 'offset'
	parameters to 'index'
...
@@ -181,7 +181,7 @@ void __do_page_cache_readahead(struct address_space *ma=
pping,
...
=20
 ...
 =09=09=09break;
@@ -220,7 +220,7 @@ void __do_page_cache_readahead(struct address_space *ma=
pping,
  * memory at once.
  */
...
@@ -240,9 +240,9 @@ void force_page_cache_readahead(struct address_space *m=
apping,
=20
...
@@ -323,21 +323,21 @@ static unsigned long get_next_ra_size(struct file_ra_=
state *ra,
  */
=20
 /*
...
=20
 /*
@@ -345,13 +345,13 @@ static pgoff_t count_history_pages(struct address_spa=
ce *mapping,
  */
...
@@ -364,10 +364,10 @@ static int try_context_readahead(struct address_space=
 *mapping,
...
=20
@@ -379,13 +379,13 @@ static int try_context_readahead(struct address_space=
 *mapping,
  */
...
@@ -397,15 +397,15 @@ static void ondemand_readahead(struct address_space *=
mapping,
 =09/*
 =09 * start of file
 =09 */
...
@@ -422,14 +422,14 @@ static void ondemand_readahead(struct address_space *=
mapping,
 =09=09pgoff_t start;
=20
 =09=09rcu_read_lock();
...
+=09=09ra->size =3D start - index;=09/* old async_size */
 ...
 =09=09ra->size =3D get_next_ra_size(ra, max_pages);
 =09=09ra->async_size =3D ra->size;
@@ -444,29 +444,29 @@ static void ondemand_readahead(struct address_space *=
mapping,
=20
 =09/*
...
;
=20
@@ -477,7 +477,7 @@ static void ondemand_readahead(struct address_space *ma=
pping,
...
@@ -496,9 +496,8 @@ static void ondemand_readahead(struct address_space *ma=
pping,
...
ore
@@ -507,7 +506,7 @@ static void ondemand_readahead(struct address_space *ma=
pping,
  */
...
+=09=09=09       pgoff_t index, unsigned long req_count)
 ...
 =09/* no read-ahead */
 =09if (!ra->ra_pages)
@@ -518,12 +517,12 @@ void page_cache_sync_readahead(struct address_space *=
mapping,
=20
 =09/* be dumb */
...
+=09=09=09   unsigned long req_count)
 ...
 =09/* no read-ahead */
 =09if (!ra->ra_pages)
@@ -570,7 +568,7 @@ page_cache_async_readahead(struct address_space *mappin=
g,
 =09=09return;
=20
 =09/* do read-ahead */
