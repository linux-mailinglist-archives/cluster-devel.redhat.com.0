...
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	by mail.lfdr.de (Postfix) with ESMTPS id 9E38D69E9A2
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	...
	bh=p31gQTiPDAmvW8W/E35m7W3gyuEf2nW27YKEhmIIZxQ=;
	b=EEHg//2qkmjv3rN45sc4UsJsMe18Mbs9EZfvE1Feqs2Fh8ym0Y6hFR4PPjiIvLH3kJlmUl
	t5vfMbwGsDlL+fCpKlCuDeFN7WfHCB8liDQbEoECOGtxzPn2c4vi8+r+Ql7GQGCwaXo8F+
	MBUoa/DtMnG+2CEph+Q9HZKXvQZHq2Y=
Received: from mimecast-mx02.redhat.com (mimecast-mx02.redhat.com
 [66.187.233.88]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-338-8hpuIZveN-OnAZg8qfxhnw-1; Tue, 21 Feb 2023 16:40:39 -0500
X-MC-Unique: 8hpuIZveN-OnAZg8qfxhnw-1
Received: from smtp.corp.redhat.com (int-mx08.intmail.prod.int.rdu2.redhat.com [10.11.54.8])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by mimecast-mx02.redhat.com (Postfix) with ESMTPS id 2EE0A87B2A4;
	Tue, 21 Feb 2023 21:40:38 +0000 (UTC)
Received: from mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (unknown [10.30.29.100])
	by smtp.corp.redhat.com (Postfix) with ESMTP id E6225C15BA0;
	Tue, 21 Feb 2023 21:40:36 +0000 (UTC)
Received: from mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (localhost [IPv6:::1])
	by mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (Postfix) with ESMTP id CF40619465A3;
	Tue, 21 Feb 2023 21:40:36 +0000 (UTC)
...
Received: from smtp.corp.redhat.com (int-mx05.intmail.prod.int.rdu2.redhat.com
 ...
 ESMTP id 5AAC4194658D for <cluster-devel@listman.corp.redhat.com>;
 Tue, 21 Feb 2023 21:40:36 +0000 (UTC)
Received: by smtp.corp.redhat.com (Postfix)
 id 4CE89440DE; Tue, 21 Feb 2023 21:40:36 +0000 (UTC)
Delivered-To: cluster-devel@redhat.com
Received: from fs-i40c-03.fs.lab.eng.bos.redhat.com
 (fs-i40c-03.fs.lab.eng.bos.redhat.com [10.16.224.23])
 by smtp.corp.redhat.com (Postfix) with ESMTP id 22BC2440D9;
 Tue, 21 Feb 2023 21:40:36 +0000 (UTC)
From: Alexander Aring <aahringo@redhat.com>
To: teigland@redhat.com
Date: Tue, 21 Feb 2023 16:40:14 -0500
Message-Id: <20230221214014.871804-7-aahringo@redhat.com>
In-Reply-To: <20230221214014.871804-1-aahringo@redhat.com>
References: <20230221214014.871804-1-aahringo@redhat.com>
MIME-Version: 1.0
X-Scanned-By: MIMEDefang 3.1 on 10.11.54.5
Subject: [Cluster-devel] [PATCH dlm/next 6/6] fs: dlm: remove deprecated
 code parts
...
---
 ...
 16 files changed, 9 insertions(+), 534 deletions(-)
...
index 86b253aa9a09..253c0a2a6471 100644
...
+#define DLM_IFLNS_DEADLOCK_CANCEL 7
 
 
 /* lkb_flags */
@@ -259,11 +252,6 @@ struct dlm_lkb {
...
+#define LSFL_CB_DELAY		8
+#define LSFL_NODIR		9
 
 /* much of this is just saving user space pointers associated with the
    lock that we pass back to the user lib with an ast */
@@ -752,15 +732,6 @@ static inline int dlm_no_directory(struct dlm_ls *ls)
...
index e4df2579048b..bc5eeeebba35 100644
--- a/fs/dlm/lock.c
+++ b/fs/dlm/lock.c
...
-static void del_timeout(struct dlm_lkb *lkb);
 ...
 /*
@@ -292,17 +291,8 @@ static void queue_cast(struct dlm_rsb *r, struct dlm_lkb *lkb, int rv)
...
@@ -1211,9 +1201,6 @@ static int _create_lkb(struct dlm_ls *ls, struct dlm_lkb **lkb_ret,
...
@@ -1732,133 +1719,6 @@ void dlm_scan_rsbs(struct dlm_ls *ls)
 	}
 }
...
@@ -2720,20 +2580,11 @@ static void confirm_master(struct dlm_rsb *r, int error)
 	}
 }
...
@@ -2786,9 +2637,6 @@ static int set_lock_args(int mode, struct dlm_lksb *lksb, uint32_t flags,
 	args->astfn = ast;
...
-#endif
 	...
 	args->lksb = lksb;
 	rv = 0;
@@ -2844,9 +2692,6 @@ static int validate_lock_args(struct dlm_ls *ls, struct dlm_lkb *lkb,
...
-#endif
  ...
  out:
 	switch (rv) {
@@ -2931,9 +2776,6 @@ static int validate_unlock_args(struct dlm_lkb *lkb, struct dlm_args *args)
 		if (is_overlap(lkb))
 			goto out;
...
-
 		if (test_bit(DLM_IFLNS_RESEND, &lkb->lkb_insflags)) {
 			...
 			rv = -EBUSY;
@@ -2972,9 +2814,6 @@ static int validate_unlock_args(struct dlm_lkb *lkb, struct dlm_args *args)
...
-
 		if (test_bit(DLM_IFLNS_RESEND, &lkb->lkb_insflags)) {
 			...
 			rv = -EBUSY;
@@ -3042,7 +2881,6 @@ static int do_request(struct dlm_rsb *r, struct dlm_lkb *lkb)
...
@@ -3111,7 +2949,6 @@ static int do_convert(struct dlm_rsb *r, struct dlm_lkb *lkb)
 		error = -EINPROGRESS;
 		del_lkb(r, lkb);
...
@@ -3398,13 +3235,8 @@ int dlm_lock(dlm_lockspace_t *lockspace,
...
@@ -4449,7 +4281,6 @@ static int receive_request_reply(struct dlm_ls *ls, struct dlm_message *ms)
...
-			add_timeout(lkb);
 			...
 			queue_cast(r, lkb, 0);
@@ -4536,7 +4367,6 @@ static void __receive_convert_reply(struct dlm_rsb *r, struct dlm_lkb *lkb,
 			munge_demoted(lkb);
 		del_lkb(r, lkb);
 		add_lkb(r, lkb, DLM_LKSTS_CONVERT);
-		add_timeout(lkb);
 	...
 	case 0:
@@ -5703,14 +5533,8 @@ int dlm_recover_process_copy(struct dlm_ls *ls, struct dlm_rcom *rc)
 	return 0;
 }
...
-#endif
 {
 	struct dlm_lkb *lkb;
 	struct dlm_args args;
@@ -5735,13 +5559,8 @@ int dlm_user_request(struct dlm_ls *ls, struct dlm_user_args *ua,
 			goto out_put;
 		}
 	}
-#ifdef CONFIG_DLM_DEPRECATED_API
...
@@ -5783,14 +5602,8 @@ int dlm_user_request(struct dlm_ls *ls, struct dlm_user_args *ua,
 	return error;
 }
...
-#endif
 {
 	struct dlm_lkb *lkb;
 	struct dlm_args args;
@@ -5827,13 +5640,8 @@ int dlm_user_convert(struct dlm_ls *ls, struct dlm_user_args *ua_tmp,
...
@@ -6150,7 +5958,6 @@ void dlm_clear_proc_locks(struct dlm_ls *ls, struct dlm_user_proc *proc)
...
index c879549aca40..3c67c5e471ed 100644
...
index 15715dd18c67..c42e8ab3463f 100644
--- a/fs/dlm/user.c
+++ b/fs/dlm/user.c
@@ -261,14 +261,6 @@ static int device_user_lock(struct dlm_user_proc *proc,
 		goto out;
 	}
...
-
 	...
 	if (!ua)
 		goto out;
@@ -281,16 +273,9 @@ static int device_user_lock(struct dlm_user_proc *proc,
 	ua->xid = params->xid;
...
-#endif
 		...
 		error = dlm_user_adopt_orphan(ls, ua,
 					 params->mode, params->flags,
@@ -299,16 +284,9 @@ static int device_user_lock(struct dlm_user_proc *proc,
 		if (!error)
 			error = lkid;
 	} else {
-#ifdef CONFIG_DLM_DEPRECATED_API
