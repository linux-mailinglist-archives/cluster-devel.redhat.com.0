...
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	by mail.lfdr.de (Postfix) with ESMTPS id 1F319632AA5
	for <lists+cluster-devel@lfdr.de>; Mon, 21 Nov 2022 18:16:47 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1669051005;
	...
	bh=FhVDQdQYLRt2Ai4ZRSmYbvGVKtLgttUmaD1jPvmdYYY=;
	b=fk0bI6QRD2FBCaz65pMKQdAqOVJFjtnyZTs24plV/P8bzdEwYSs+fXjRuKhOrw0nklkDtp
	4kn9wyDpTDPDMgosgmOSfJXK+hvOSdtFw+nUdJmcDqGKm4XVheADXM0rCMH3LEgaNdyXmA
	lvvkKmA9Swwd9azVNuB1oK0n8GRhKpQ=
Received: from mimecast-mx02.redhat.com (mx3-rdu2.redhat.com
 [66.187.233.73]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-336-OH4MNPfhOFCxRaECVoEaXQ-1; Mon, 21 Nov 2022 12:16:41 -0500
X-MC-Unique: OH4MNPfhOFCxRaECVoEaXQ-1
Received: from smtp.corp.redhat.com (int-mx01.intmail.prod.int.rdu2.redhat.com [10.11.54.1])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by mimecast-mx02.redhat.com (Postfix) with ESMTPS id D25762A59565;
	Mon, 21 Nov 2022 17:16:40 +0000 (UTC)
Received: from mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com [10.30.29.100])
	by smtp.corp.redhat.com (Postfix) with ESMTP id 857A840C83AA;
	Mon, 21 Nov 2022 17:16:40 +0000 (UTC)
Received: from mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (localhost [IPv6:::1])
	by mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (Postfix) with ESMTP id 4BDD4194658C;
	Mon, 21 Nov 2022 17:16:38 +0000 (UTC)
X-Original-To: cluster-devel@listman.corp.redhat.com
Delivered-To: cluster-devel@listman.corp.redhat.com
Received: from smtp.corp.redhat.com (int-mx04.intmail.prod.int.rdu2.redhat.com
 [10.11.54.4])
 by mm-prod-listman-01.mail-001.prod.us-east-1.aws.redhat.com (Postfix) with
 ESMTP id 12F7F1946587 for <cluster-devel@listman.corp.redhat.com>;
 Mon, 21 Nov 2022 17:16:37 +0000 (UTC)
Received: by smtp.corp.redhat.com (Postfix)
 id EA26D200B40B; Mon, 21 Nov 2022 17:16:36 +0000 (UTC)
Delivered-To: cluster-devel@redhat.com
Received: from mimecast-mx02.redhat.com
 (mimecast04.extmail.prod.ext.rdu2.redhat.com [10.11.55.20])
 by smtp.corp.redhat.com (Postfix) with ESMTPS id E18AF2027061
 for <cluster-devel@redhat.com>; Mon, 21 Nov 2022 17:16:36 +0000 (UTC)
Received: from us-smtp-1.mimecast.com (us-smtp-2.mimecast.com [207.211.31.81])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256
 bits)) (No client certificate requested)
 by mimecast-mx02.redhat.com (Postfix) with ESMTPS id B9EB4101E14D
 for <cluster-devel@redhat.com>; Mon, 21 Nov 2022 17:16:36 +0000 (UTC)
Received: from dfw.source.kernel.org (dfw.source.kernel.org
 [139.178.84.217]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-395--ziPzFrTMz6MqDAgwqvAmg-1; Mon, 21 Nov 2022 12:16:24 -0500
X-MC-Unique: -ziPzFrTMz6MqDAgwqvAmg-1
...
> > +
> > +=09const struct file_lock_operations *fl_ops;=09/* Callbacks for files=
ystems */
> > +=09const struct lock_manager_operations *fl_lmops;=09/* Callbacks for =
lockmanagers */
> > +=09union {
> > +=09=09struct nfs_lock_info=09nfs_fl;
> > +=09=09struct nfs4_lock_info=09nfs4_fl;
> > +=09=09struct {
> > +=09=09=09struct list_head link;=09/* link in AFS vnode's pending_locks=
 list */
...
> > +=09 */
> > +=09smp_mb();
> > +=09if (inode->i_flctx && !list_empty_careful(&inode->i_flctx->flc_leas=
e))
