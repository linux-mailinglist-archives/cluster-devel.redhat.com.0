...
Received: from us-smtp-delivery-74.mimecast.com (us-smtp-delivery-74.mimecast.com [63.128.21.74])
	by mail.lfdr.de (Postfix) with ESMTP id 36EA918D03B
	for <lists+cluster-devel@lfdr.de>; Fri, 20 Mar 2020 15:23:25 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1584714204;
	...
	bh=+ZboD5IBoJc2fGaQUKZkMPrX1VB6sNLCeJbKjam28Zg=;
	b=O6sm3xwYNmw2yRcKCY5HVW+tMYnkayLq2mchXE/QmDZ75JLKGylBSQCV4PrHjNTPVQQtn+
	jpeG+uc8014DtamxWlgt5CGTUTzs85E90z56lFvl0ocD2uG9Jni6zv48X2kGeCTJN74lNh
	UZdYXT2o47a/YqT7T8SKIC3hcBH8wzw=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-186-l_db47WSPiyq1jKpJDgrnQ-1; Fri, 20 Mar 2020 10:23:22 -0400
X-MC-Unique: l_db47WSPiyq1jKpJDgrnQ-1
Received: from smtp.corp.redhat.com (int-mx08.intmail.prod.int.phx2.redhat.com [10.5.11.23])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 0238F18FF67E;
	Fri, 20 Mar 2020 14:22:55 +0000 (UTC)
Received: from colo-mx.corp.redhat.com (colo-mx01.intmail.prod.int.phx2.redhat.com [10.5.11.20])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id D8C42CFC8;
	Fri, 20 Mar 2020 14:22:54 +0000 (UTC)
Received: from lists01.pubmisc.prod.ext.phx2.redhat.com (lists01.pubmisc.prod.ext.phx2.redhat.com [10.5.19.33])
	by colo-mx.corp.redhat.com (Postfix) with ESMTP id B73ED18089CD;
	Fri, 20 Mar 2020 14:22:54 +0000 (UTC)
Received: from smtp.corp.redhat.com (int-mx04.intmail.prod.int.rdu2.redhat.com
	[10.11.54.4])
	by lists01.pubmisc.prod.ext.phx2.redhat.com (8.13.8/8.13.8) with ESMTP
	id 02KEMmUT021982 for <cluster-devel@listman.util.phx.redhat.com>;
	Fri, 20 Mar 2020 10:22:48 -0400
Received: by smtp.corp.redhat.com (Postfix)
	id 8E687201803C; Fri, 20 Mar 2020 14:22:48 +0000 (UTC)
Delivered-To: cluster-devel@redhat.com
Received: from mimecast-mx02.redhat.com
	(mimecast06.extmail.prod.ext.rdu2.redhat.com [10.11.55.22])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id 8A771201803A
	for <cluster-devel@redhat.com>; Fri, 20 Mar 2020 14:22:48 +0000 (UTC)
Received: from us-smtp-1.mimecast.com (us-smtp-1.mimecast.com [205.139.110.61])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-SHA384 (256/256 bits))
	(No client certificate requested)
	by mimecast-mx02.redhat.com (Postfix) with ESMTPS id 667A7185A791
	for <cluster-devel@redhat.com>; Fri, 20 Mar 2020 14:22:48 +0000 (UTC)
Received: from bombadil.infradead.org (bombadil.infradead.org
	[198.137.202.133]) (Using TLS) by relay.mimecast.com with ESMTP id
	us-mta-396-U3BmoXUiMziOTAeQo3EtUg-1; Fri, 20 Mar 2020 10:22:45 -0400
X-MC-Unique: U3BmoXUiMziOTAeQo3EtUg-1
...
X-MIME-Autoconverted: from quoted-printable to 8bit by
	lists01.pubmisc.prod.ext.phx2.redhat.com id 02KEMmUT021982
...
Subject: [Cluster-devel] [PATCH v9 16/25] fs: Convert mpage_readpages to
	mpage_readahead
...
c)
@@ -3104,7 +3103,7 @@ static sector_t _exfat_bmap(struct address_space *map=
ping, sector_t block)
=20
...
ping,
@@ -2062,7 +2061,7 @@ static int blkdev_writepages(struct address_space *ma=
pping,
=20
...
@@ -842,7 +835,7 @@ static const struct address_space_operations gfs2_jdata=
_aops =3D {
