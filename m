...
Received: from mx1.redhat.com (mx1.redhat.com [209.132.183.28])
	by mail.lfdr.de (Postfix) with ESMTPS id A1DB0904C6
	for <lists+cluster-devel@lfdr.de>; Fri, 16 Aug 2019 17:38:02 +0200 (CEST)
Received: from smtp.corp.redhat.com (int-mx02.intmail.prod.int.phx2.redhat.com [10.5.11.12])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by mx1.redhat.com (Postfix) with ESMTPS id 26C817FDFD;
	Fri, 16 Aug 2019 15:38:01 +0000 (UTC)
Received: from colo-mx.corp.redhat.com (colo-mx02.intmail.prod.int.phx2.redhat.com [10.5.11.21])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id 77B764145;
	Fri, 16 Aug 2019 15:38:00 +0000 (UTC)
Received: from lists01.pubmisc.prod.ext.phx2.redhat.com (lists01.pubmisc.prod.ext.phx2.redhat.com [10.5.19.33])
	by colo-mx.corp.redhat.com (Postfix) with ESMTP id 2FD8E206CD;
	Fri, 16 Aug 2019 15:37:59 +0000 (UTC)
Received: from smtp.corp.redhat.com (int-mx05.intmail.prod.int.phx2.redhat.com
	[10.5.11.15])
	by lists01.pubmisc.prod.ext.phx2.redhat.com (8.13.8/8.13.8) with ESMTP
	id x7GFYu4F000870 for <cluster-devel@listman.util.phx.redhat.com>;
	Fri, 16 Aug 2019 11:34:56 -0400
Received: by smtp.corp.redhat.com (Postfix)
	id 51FF784258; Fri, 16 Aug 2019 15:34:56 +0000 (UTC)
Delivered-To: cluster-devel@redhat.com
Received: from mx1.redhat.com (ext-mx12.extmail.prod.ext.phx2.redhat.com
	[10.5.110.41])
	by smtp.corp.redhat.com (Postfix) with ESMTPS id 0117D8427F
	for <cluster-devel@redhat.com>; Fri, 16 Aug 2019 15:34:53 +0000 (UTC)
Received: from mail-lj1-f193.google.com (mail-lj1-f193.google.com
	[209.85.208.193])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by mx1.redhat.com (Postfix) with ESMTPS id 472CD316D8D0
	for <cluster-devel@redhat.com>; Fri, 16 Aug 2019 15:34:48 +0000 (UTC)
Received: by mail-lj1-f193.google.com with SMTP id f9so5648043ljc.13
	for <cluster-devel@redhat.com>; Fri, 16 Aug 2019 08:34:48 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
	...
	b=
X-Gm-Message-State: APjAAAUB/L9Bmvub5ze630ThEN0pqrM/39v42sB+peqSLJni22uG435v
	/tA0tYmpPoGhXNCmjOJCiv3mz2FdqH+EAexHdoKAKw==
...
X-Greylist: Sender IP whitelisted, not delayed by milter-greylist-4.5.16
	...
	Fri, 16 Aug 2019 15:34:49 +0000 (UTC)
X-Greylist: inspected by milter-greylist-4.5.16 (mx1.redhat.com [10.5.110.41]);
	Fri, 16 Aug 2019 15:34:49 +0000 (UTC) for IP:'209.85.208.193'
	DOMAIN:'mail-lj1-f193.google.com'
	HELO:'mail-lj1-f193.google.com' FROM:'salyzyn@google.com' RCPT:''
X-RedHat-Spam-Score: -15.863  (DKIMWL_WL_MED, DKIM_SIGNED, DKIM_VALID,
	DKIM_VALID_AU, ENV_AND_HDR_SPF_MATCH, HTML_MESSAGE,
	RCVD_IN_DNSWL_NONE, RCVD_IN_MSPIKE_H2, SPF_HELO_NONE, SPF_PASS,
	USER_IN_DEF_DKIM_WL,
	USER_IN_DEF_SPF_WL) 209.85.208.193 mail-lj1-f193.google.com
	209.85.208.193 mail-lj1-f193.google.com <salyzyn@google.com>
X-Scanned-By: MIMEDefang 2.84 on 10.5.110.41
X-Scanned-By: MIMEDefang 2.79 on 10.5.11.15
X-loop: cluster-devel@redhat.com
X-Mailman-Approved-At: Fri, 16 Aug 2019 11:37:56 -0400
Cc: Latchesar Ionkov <lucho@ionkov.net>, Dave Kleikamp <shaggy@kernel.org>,
	...
	Serge Hallyn <serge@hallyn.com>, =?UTF-8?Q?Ernesto_A=2E_Fern=C3=A1ndez?=
...
Subject: Re: [Cluster-devel] [PATCH v4] Add flags option to get xattr method
...
X-Greylist: Sender IP whitelisted, not delayed by milter-greylist-4.5.16 (mx1.redhat.com [10.5.110.27]); Fri, 16 Aug 2019 15:38:01 +0000 (UTC)
